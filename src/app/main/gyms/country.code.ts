export class CountryCode {
    ...
    */   
    ...
    data: any[] = [{
        'States': [{'Cities': ['Eshkashem', 'Fayzabad', 'Jurm', 'Khandud', 'Qal\'eh-ye Panjeh'], 'StateName': 'Badakhshan'}, {
            'Cities': ['Bala Morghab', 'Qal\'eh-ye Naw'],
            'StateName': 'Badgis'
        }, {
            'Cities': ['Andarab', 'Baghlan', 'Dahaneh-ye Ghawri', 'Nahrin', 'Pol-e Khumri'],
            'StateName': 'Baglan'
        }, {'Cities': ['Balkh', 'Dawlatabad', 'Mazar-e Sharif', 'Qarchi Gak', 'Shulgara', 'Tash Gozar'], 'StateName': 'Balkh'}, {
            ...
            'StateName': 'Jawzjan'
        }, {'Cities': ['Baghrami', 'Kabul', 'Mir Bachchekut', 'Paghman', 'Qarabagh', 'Sarawbi'], 'StateName': 'Kabul'}, {
            'Cities': ['Mahmud-e Raqi', 'Taghab'],
            'StateName': 'Kapisa'
        }, {'Cities': ['Khawst'], 'StateName': 'Khawst'}, {'Cities': ['Asadabad', 'Asmar'], 'StateName': 'Kunar'}, {
            'Cities': ['Mehtar Lam'],
            'StateName': 'Lagman'
        }, {'Cities': ['Azraw', 'Baraki Barak', 'Pol-e Alam'], 'StateName': 'Lawghar'}, {
            'Cities': ['Achin', 'Batsawul', 'Hugyani', 'Jalalabad', 'Nader Shah Kawt'],
            'StateName': 'Nangarhar'
        }, {'Cities': ['Chahar Burjak', 'Chakhansur', 'Khash', 'Mirabad', 'Rudbar', 'Zaranj'], 'StateName': 'Nimruz'}, {
            'Cities': ['Nuristan'],
            'StateName': 'Nuristan'
        }, {'Cities': ['Orgun', 'Zareh Sharan', 'Zarghun Shahr'], 'StateName': 'Paktika'}, {
            'Cities': ['\'Ali Khayl', 'Ghardez'],
            'StateName': 'Paktiya'
        }, {'Cities': ['Charikar', 'Jabal-os-Saraj'], 'StateName': 'Parwan'}, {
            'Cities': ['Qandahar'],
            'StateName': 'Qandahar'
        }, {'Cities': ['Dasht-e Archa', 'Emam Saheb', 'Hazart Imam', 'Khanabad', 'Qal\'eh-ye Zal', 'Qunduz'], 'StateName': 'Qunduz'}, {
            'Cities': ['Aybak', 'Kholm'],
            'StateName': 'Samangan'
            ...
            'StateName': 'Wardag'
        }, {'Cities': ['Qalat-e Ghilzay'], 'StateName': 'Zabul'}], 'CountryName': 'Afghanistan', 'dial_code': '93', 'code': 'AF'
    }, {
        'States': [{'Cities': ['Berat', 'Polican', 'Ure Vajgurore'], 'StateName': 'Berat'}, {'Cities': ['Bulqize'], 'StateName': 'Bulqize'}, {
            'Cities': ['Delvine'],
            'StateName': 'Delvine'
        }, {'Cities': ['Bilisht'], 'StateName': 'Devoll'}, {'Cities': ['Maqellare', 'Peshkopi'], 'StateName': 'Dibre'}, {
            'Cities': ['Durres', 'Shijak'],
            'StateName': 'Durres'
        }, {'Cities': ['Cerrik', 'Elbasan', 'Kerrabe'], 'StateName': 'Elbasan'}, {
            'Cities': ['Fier', 'Patos', 'Roskovec'],
            'StateName': 'Fier'
        }, {'Cities': ['Gjirokaster', 'Libohove'], 'StateName': 'Gjirokaster'}, {'Cities': ['Gramsh'], 'StateName': 'Gramsh'}, {
            'Cities': ['Krume'],
            'StateName': 'Has'
        }, {'Cities': ['Kavaje'], 'StateName': 'Kavaje'}, {'Cities': ['Erseke', 'Leskovik'], 'StateName': 'Kolonje'}, {
            'Cities': ['Korce', 'Maliq'],
            'StateName': 'Korce'
        }, {'Cities': ['Fushe-Kruje', 'Kruje', 'Mamurras', 'Milot'], 'StateName': 'Kruje'}, {'Cities': ['Kucove'], 'StateName': 'Kucove'}, {
            'Cities': ['Kukes'],
            'StateName': 'Kukes'
        }, {'Cities': ['Lac'], 'StateName': 'Kurbin'}, {'Cities': ['Lezhe', 'Shengjin'], 'StateName': 'Lezhe'}, {
            'Cities': ['Librazhd', 'Perrenjas'],
            'StateName': 'Librazhd'
        }, {'Cities': ['Lushnje', 'Rrogozhine'], 'StateName': 'Lushnje'}, {'Cities': ['Ballsh'], 'StateName': 'Mallakaster'}, {
            'Cities': [],
            'StateName': 'Malsi e Madhe'
        }, {'Cities': ['Burrel', 'Klos', 'Kraste', 'Ulze'], 'StateName': 'Mat'}, {'Cities': ['Kurbnesh', 'Rreshen', 'Rubik'], 'StateName': 'Mirdite'}, {
            'Cities': ['Peqin'],
            'StateName': 'Peqin'
        }, {'Cities': ['Kelcyre', 'Permet'], 'StateName': 'Permet'}, {'Cities': ['Pogradec'], 'StateName': 'Pogradec'}, {
            'Cities': ['Fierze', 'Fushe-Arrez', 'Puke'],
            'StateName': 'Puke'
        }, {'Cities': ['Konispol', 'Sarande'], 'StateName': 'Sarande'}, {'Cities': ['Shkoder'], 'StateName': 'Shkoder'}, {
            'Cities': ['Corovode'],
            'StateName': 'Skrapar'
        }, {'Cities': ['Memaliaj', 'Tepelene'], 'StateName': 'Tepelene'}, {'Cities': ['Kamze', 'Paskuqan', 'Tirane', 'Vore'], 'StateName': 'Tirane'}, {
            'Cities': ['Bajram Curri'],
            'StateName': 'Tropoje'
        }, {'Cities': ['Himare', 'Orikum', 'Selenice', 'Vlore'], 'StateName': 'Vlore'}], 'CountryName': 'Albania', 'dial_code': '355', 'code': 'AL'
    }, {
        'States': [{'Cities': [], 'StateName': '\'Ayn Daflah'}, {'Cities': [], 'StateName': '\'Ayn Tamushanat'}, {
            ...
            'StateName': 'Ghalizan'
        }, {'Cities': ['Biryan', 'Bu Nura', 'Ghardaia', 'Ghardayah', 'Matlili', 'al-Ghuli\'ah', 'al-Qararah'], 'StateName': 'Ghardayah'}, {
            'Cities': ['Ilizi'],
            'StateName': 'Ilizi'
        }, {
            ...
            'StateName': 'Muaskar'
        }, {'Cities': ['\'Ayn Tadalas', 'Hassi Mamash', 'Mazaghran', 'Mustaghanam', 'Sidi Ali'], 'StateName': 'Mustaghanam'}, {
            ...
            'StateName': 'Satif'
        }, {'Cities': ['\'Ayn-al-Hajar', 'Sayda\''], 'StateName': 'Sayda\''}, {'Cities': [], 'StateName': 'Sidi ban-al-\'Abbas'}, {
            'Cities': [],
            'StateName': 'Suq Ahras'
        }, {
            ...
            'StateName': 'Warqla'
        }, {'Cities': [], 'StateName': 'Wilaya d Alger'}, {'Cities': [], 'StateName': 'Wilaya de Bejaia'}, {
            'Cities': [],
            'StateName': 'Wilaya de Constantine'
        }, {'Cities': ['Aflu', 'Hassi al-Raml', 'al-Aghwat'], 'StateName': 'al-Aghwat'}, {
        ...
        }, {'Cities': ['Ban Mahdi', 'Bani Amar', 'Basbas', 'Dariyan', 'Saba\'ita Muk', 'al-Qal\'ah', 'at-Tarif'], 'StateName': 'at-Tarif'}],
        'CountryName': 'Algeria',
        'dial_code': '213',
        'code': 'DZ'
    }, {
        'States': [{
            ...
            'StateName': 'Western'
        }], 'CountryName': 'American Samoa', 'dial_code': '1684', 'code': 'AS'
    }, {
        'States': [{'Cities': [], 'StateName': 'Andorra la Vella'}, {'Cities': ['Canillo'], 'StateName': 'Canillo'}, {'Cities': ['Encamp'], 'StateName': 'Encamp'}, {
            'Cities': [],
            'StateName': 'La Massana'
        }, {'Cities': [], 'StateName': 'Les Escaldes'}, {'Cities': ['Ordino'], 'StateName': 'Ordino'}, {'Cities': [], 'StateName': 'Sant Julia de Loria'}],
        'CountryName': 'Andorra',
        'dial_code': '376',
        'code': 'AD'
    }, {
        'States': [{'Cities': ['Caxito'], 'StateName': 'Bengo'}, {
            'Cities': ['Benguela', 'Lobito'],
            'StateName': 'Benguela'
        }, {'Cities': ['Camacupa', 'Catabola', 'Catumbela', 'Chissamba', 'Kuito'], 'StateName': 'Bie'}, {'Cities': ['Cabinda'], 'StateName': 'Cabinda'}, {
            'Cities': ['Ondjiva'],
            'StateName': 'Cunene'
        }, {'Cities': ['Caala', 'Catchiungo', 'Huambo', 'Longonjo'], 'StateName': 'Huambo'}, {
            'Cities': ['Caconda', 'Caluquembe', 'Lubango'],
            'StateName': 'Huila'
        }, {'Cities': ['Menongue'], 'StateName': 'Kuando-Kubango'}, {'Cities': [], 'StateName': 'Kwanza Norte'}, {'Cities': [], 'StateName': 'Kwanza Sul'}, {
            'Cities': ['Luanda'],
            'StateName': 'Luanda'
        }, {'Cities': [], 'StateName': 'Lunda Norte'}, {'Cities': [], 'StateName': 'Lunda Sul'}, {
            'Cities': ['Malanje'],
            'StateName': 'Malanje'
        }, {'Cities': ['Cazaje', 'Leua', 'Luau', 'Luena', 'Lumeje'], 'StateName': 'Moxico'}, {'Cities': ['Namibe'], 'StateName': 'Namibe'}, {
            'Cities': ['Camabatela', 'Uige'],
            'StateName': 'Uige'
        }, {'Cities': ['M\'banza-Kongo', 'N\'zeto', 'Soyo'], 'StateName': 'Zaire'}], 'CountryName': 'Angola', 'dial_code': '244', 'code': 'AO'
    }, {'States': [{'Cities': [], 'StateName': 'Other Provinces'}], 'CountryName': 'Anguilla', 'dial_code': '1264', 'code': 'AI'}, {
        'States': [{
            'Cities': [],
            'StateName': 'Sector claimed by Argentina\/Ch'
        }, {'Cities': [], 'StateName': 'Sector claimed by Argentina\/UK'}, {'Cities': [], 'StateName': 'Sector claimed by Australia'}, {
            'Cities': [],
            'StateName': 'Sector claimed by France'
        }, {'Cities': [], 'StateName': 'Sector claimed by New Zealand'}, {'Cities': [], 'StateName': 'Sector claimed by Norway'}, {'Cities': [], 'StateName': 'Unclaimed Sector'}],
        'CountryName': 'Antarctica',
        'dial_code': '672',
        'code': 'AQ'
    }, {
        'States': [{'Cities': ['Codrington'], 'StateName': 'Barbuda'}, {'Cities': [], 'StateName': 'Saint George'}, {'Cities': [], 'StateName': 'Saint John'}, {
            'Cities': [],
            'StateName': 'Saint Mary'
        }, {'Cities': [], 'StateName': 'Saint Paul'}, {'Cities': [], 'StateName': 'Saint Peter'}, {'Cities': [], 'StateName': 'Saint Philip'}], 'CountryName': 'Antigua And Barbuda'
    }, {
        'States': [{'Cities': [], 'StateName': 'Buenos Aires'}, {'Cities': ['Catamarca'], 'StateName': 'Catamarca'}, {
            ...
            'StateName': 'Cordoba'
        }, {'Cities': ['Corrientes', 'Goya', 'Mercedes', 'San Lorenzo'], 'StateName': 'Corrientes'}, {'Cities': [], 'StateName': 'Distrito Federal'}, {
            'Cities': [],
            'StateName': 'Entre Rios'
        }, {'Cities': ['Formosa'], 'StateName': 'Formosa'}, {'Cities': ['Jujuy', 'Libertador General San Martin', 'San Pedro'], 'StateName': 'Jujuy'}, {
            'Cities': [],
            'StateName': 'La Pampa'
        }, {'Cities': [], 'StateName': 'La Rioja'}, {
            'Cities': ['Godoy Cruz', 'Lujan', 'Mendoza', 'Rivadavia', 'San Martin', 'San Rafael'],
            'StateName': 'Mendoza'
        }, {'Cities': ['Eldorado', 'Obera', 'Posadas'], 'StateName': 'Misiones'}, {'Cities': ['Cutral Co', 'Neuquen'], 'StateName': 'Neuquen'}, {
            'Cities': [],
            'StateName': 'Rio Negro'
        }, {'Cities': ['Salta', 'San Ramon de la Nueva Oran', 'Tartagal'], 'StateName': 'Salta'}, {'Cities': [], 'StateName': 'San Juan'}, {
            'Cities': [],
            'StateName': 'San Luis'
        }, {'Cities': [], 'StateName': 'Santa Cruz'}, {'Cities': [], 'StateName': 'Santa Fe'}, {'Cities': [], 'StateName': 'Santiago del Estero'}, {
            'Cities': [],
            'StateName': 'Tierra del Fuego'
        }, {'Cities': ['Tucuman'], 'StateName': 'Tucuman'}], 'CountryName': 'Argentina', 'dial_code': '54', 'code': 'AR'
    }, {
        'States': [{'Cities': ['Ashtarak', 'Talin'], 'StateName': 'Aragatsotn'}, {'Cities': ['Ararat', 'Artashat'], 'StateName': 'Ararat'}, {
            'Cities': ['Armavir', 'Vagharshapat'],
            'StateName': 'Armavir'
        }, {'Cities': ['Gavar', 'Martuni', 'Sevan', 'Vardenis'], 'StateName': 'Gegharkunik'}, {
            'Cities': ['Abovyan', 'Arzni', 'Charentsavan', 'Hrazdan'],
            'StateName': 'Kotaik'
        }, {'Cities': ['Akhtala', 'Alaverdi', 'Spitak', 'Stepanavan', 'Tashir', 'Vanadzor'], 'StateName': 'Lori'}, {
            'Cities': ['Artik', 'Gyumri'],
            'StateName': 'Shirak'
        }, {'Cities': ['Stepanakert'], 'StateName': 'Stepanakert'}, {
            'Cities': ['Angeghakot', 'Goris', 'Kajaran', 'Kapan', 'Meghri', 'Sisian'],
            'StateName': 'Syunik'
        }, {'Cities': ['Dilijan', 'Ijevan'], 'StateName': 'Tavush'}, {'Cities': [], 'StateName': 'Vayots Dzor'}, {'Cities': ['Yerevan'], 'StateName': 'Yerevan'}],
        'CountryName': 'Armenia',
        'dial_code': '374',
        'code': 'AM'
    }, {'States': [{'Cities': ['Aruba'], 'StateName': 'Aruba'}], 'CountryName': 'Aruba', 'dial_code': '297', 'code': 'AW'}, {
        'States': [{'Cities': ['Glenfield', 'Henderson', 'Milford'], 'StateName': 'Auckland'}, {
            'Cities': [],
            'StateName': 'Australian Capital Territory'
        }, {'Cities': ['Balgowlah'], 'StateName': 'Balgowlah'}, {'Cities': ['Balmain'], 'StateName': 'Balmain'}, {'Cities': ['Bankstown'], 'StateName': 'Bankstown'}, {
            'Cities': [],
            'StateName': 'Baulkham Hills'
        }, {'Cities': [], 'StateName': 'Bonnet Bay'}, {'Cities': ['Camberwell'], 'StateName': 'Camberwell'}, {'Cities': [], 'StateName': 'Carole Park'}, {
            'Cities': [],
            'StateName': 'Castle Hill'
        }, {'Cities': ['Caulfield'], 'StateName': 'Caulfield'}, {'Cities': ['Chatswood'], 'StateName': 'Chatswood'}, {
            'Cities': ['Cheltenham'],
            'StateName': 'Cheltenham'
        }, {'Cities': ['Cherrybrook'], 'StateName': 'Cherrybrook'}, {'Cities': ['Clayton'], 'StateName': 'Clayton'}, {
            'Cities': ['Collingwood'],
            'StateName': 'Collingwood'
        }, {'Cities': [], 'StateName': 'Frenchs Forest'}, {'Cities': ['Hawthorn'], 'StateName': 'Hawthorn'}, {
            'Cities': ['Jannnali'],
            'StateName': 'Jannnali'
        }, {'Cities': ['Knoxfield'], 'StateName': 'Knoxfield'}, {'Cities': ['Melbourne', 'South Oakleigh'], 'StateName': 'Melbourne'}, {
            'Cities': [],
            'StateName': 'New South Wales'
        }, {'Cities': [], 'StateName': 'Northern Territory'}, {'Cities': ['Cottesole', 'Darch', 'Mullaloo', 'Noranda', 'Osborne Park', 'Willetton'], 'StateName': 'Perth'}, {
            'Cities': ['Acacia Ridge', 'Aitkenvale', 'Alderley', 'Alexander Hills', 'Archerfield', 'Ashmore', 'Atherton', 'Ayr', 'Beachmere', 'Beenleigh', 'Beerwah', 'Bell', 'Belmont', 'Biloela', 'Birkdale', 'Blackwater', 'Bongaree', 'Bonogin', 'Boonah', 'Bowen', 'Brendale', 'Brisbane', 'Buddina', 'Buderim', 'Bundaberg', 'Bundall', 'Burleigh Heads', 'Burpengary', 'Cabaland', 'Caboolture', 'Cairns', 'Cairns Northern Beaches', 'Caloundra', 'Capalaba', 'Charters Towers', 'Childers', 'Cleveland', 'Coolum Beach', 'Coopers Plain', 'Dalby', 'Deception Bay', 'Eagle Farm', 'Eagleby', 'Emerald', 'Emundi', 'Forest Lake', 'Gatton', 'Gladstone', 'Gold Coast', 'Gowrie Junction', 'Gympie', 'Helensvale', 'Hervey Bay', 'Ingham', 'Innisfail', 'Ipswich', 'Jindalee', 'Julatten', 'Kawana Waters', 'Kingaroy', 'Lawnton', 'Loganholme', 'Mackay', 'Mareeba', 'Maroochydore', 'Maroochydore-Mooloolaba', 'Maryborough', 'Miami', 'Milton', 'Molendinar', 'Moranbah', 'Morayfield', 'Mossman', 'Mount Glorious', 'Mount Isa', 'Murarrie', 'Nairand Kay', 'Nambour', 'Nerang', 'Nobby Beach', 'Noosa Heads', 'Noosaville', 'Paddington', 'Port Douglas', 'Robina', 'Rockhampton', 'Rocklea', 'Roma', 'Rubyvale', 'Sanctuary Cove', 'Slade Point', 'Southport', 'Suburb', 'Sunshine Coast', 'Tewantin-Noosa', 'The Summit', 'Toowong', 'Toowoomba', 'Townsville', 'Victoria Point', 'Warwick', 'Willawong', 'Yatala', 'Yeppoon', 'Zillmere'],
            ...
            'StateName': 'Victoria'
        }, {'Cities': [], 'StateName': 'Werribee south'}, {'Cities': [], 'StateName': 'Western Australia'}, {'Cities': ['Wheeler'], 'StateName': 'Wheeler'}],
        'CountryName': 'Australia',
        'dial_code': '61',
        'code': 'AU'
    }, {
        'States': [{'Cities': [], 'StateName': 'Bundesland Salzburg'}, {'Cities': [], 'StateName': 'Bundesland Steiermark'}, {
            'Cities': [],
            ...
            'StateName': 'Karnten'
        }, {'Cities': [], 'StateName': 'Liezen'}, {'Cities': [], 'StateName': 'Lower Austria'},
            {
            ...
            {'Cities': ['Deutschfeistritz', 'Liezen', 'Sankt Bartholoma'], 'StateName': 'Styria'},
            {
            ...
            {'Cities': ['Vienna', 'Wien'], 'StateName': 'Wien'}], 'CountryName': 'Austria', 'dial_code': '43', 'code': 'AT'
    },
        {
            'States': [
                {
                ...
                {'Cities': ['Astara', 'Goytapa', 'Lankaran', 'Masalli', 'Neftcala'], 'StateName': 'Lankaran'},
                {'Cities': ['Agcabadi', 'Agdam', 'Barda', 'Mingacevir', 'Tartar', 'Yevlax'], 'StateName': 'Mil-Qarabax'},
                {'Cities': ['Ali Bayramli', 'Bilasuvar', 'Calilabad', 'Qarasu', 'Qazimammad', 'Saatli', 'Sabirabad', 'Salyan'], 'StateName': 'Mugan-Salyan'},
                {'Cities': ['Susa', 'Xankandi', 'Xocavand'], 'StateName': 'Nagorni-Qarabax'},
                {'Cities': ['Culfa', 'Naxcivan', 'Ordubad', 'Sadarak', 'Sarur'], 'StateName': 'Naxcivan'},
                {'Cities': ['Beylaqan', 'Fuzuli', 'Imisli'], 'StateName': 'Priaraks'},
                {'Cities': ['Agstafa', 'Gadabay', 'Kovlar', 'Qaracamirli', 'Qazax', 'Samkir', 'Tovuz'], 'StateName': 'Qazax'},
                {'Cities': ['Amircan', 'Balakan', 'Katex', 'Oguz', 'Qabala', 'Qax', 'Saki', 'Zaqatala'], 'StateName': 'Saki'},
                {'Cities': ['Agdas', 'Agsu', 'Goycay', 'Ismayilli', 'Kurdamir', 'Samaxi', 'Ucar', 'Zardab'], 'StateName': 'Sirvan'},
                {'Cities': ['Davaci', 'Quba', 'Qusar', 'Siyazan', 'Xacmaz', 'Xudat'], 'StateName': 'Xacmaz'}], 'CountryName': 'Azerbaijan', 'dial_code': '994', 'code': 'AZ'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'San Salvador'}], 'CountryName': 'Bahamas The', 'dial_code': '1242', 'code': 'BS'
        },
        {
            'States': [
                ...
                {'Cities': ['ar-Rifa\'a'], 'StateName': 'ar-Rifa\'a'}], 'CountryName': 'Bahrain', 'dial_code': '973', 'code': 'BH'
        },
        {
            'States': [
                ...
                {'Cities': ['Barisal', 'Gaurnadi', 'Mehendiganj', 'Nalchiti'], 'StateName': 'Barisal'},
                {'Cities': ['Bhola', 'Burhanuddin', 'Char Fasson', 'Lalmohan'], 'StateName': 'Bhola'},
                ...
                {'Cities': ['Boalkhali', 'Chattagam', 'Fatikchhari', 'Lohagara', 'Patiya', 'Rangunia', 'Raozan', 'Sandip', 'Satkaniya'], 'StateName': 'Chattagam'},
                {'Cities': [], 'StateName': 'Chittagong Division'},
                {'Cities': ['Alamdanga', 'Chuadanga', 'Damurhuda'], 'StateName': 'Chuadanga'},
                {'Cities': ['Dhaka', 'Dhamrai', 'Dohar'], 'StateName': 'Dhaka'},
                {'Cities': ['Bochanganj', 'Dinajpur', 'Fulbari', 'Parbatipur'], 'StateName': 'Dinajpur'},
                {'Cities': ['Bhanga', 'Char Bhadrasan', 'Faridpur'], 'StateName': 'Faridpur'},
                ...
                {'Cities': ['Abhaynagar', 'Jessor', 'Jhikargachha', 'Keshabpur'], 'StateName': 'Jessor'},
                {'Cities': ['Jhalakati'], 'StateName': 'Jhalakati'},
                {'Cities': ['Jhanaydah', 'Kaliganj', 'Kotchandpur', 'Shailkupa'], 'StateName': 'Jhanaydah'},
                {'Cities': ['Khagrachari', 'Manikchhari', 'Ramgarh'], 'StateName': 'Khagrachhari'},
                {'Cities': ['Khulna', 'Phultala'], 'StateName': 'Khulna'},
                {'Cities': ['Bajitpur', 'Bhairab Bazar', 'Itna', 'Kishorganj'], 'StateName': 'Kishorganj'},
                {'Cities': [], 'StateName': 'Koks Bazar'},
                {'Cities': ['Komilla', 'Laksham'], 'StateName': 'Komilla'},
                {'Cities': ['Chilmari', 'Kurigram', 'Nageshwari', 'Ulipur'], 'StateName': 'Kurigram'},
                {'Cities': ['Bheramara', 'Kushtiya'], 'StateName': 'Kushtiya'},
                {'Cities': ['Lakshmipur', 'Ramganj', 'Ramgati', 'Raypur'], 'StateName': 'Lakshmipur'},
                {'Cities': [], 'StateName': 'Lalmanir Hat'},
                {'Cities': ['Madaripur'], 'StateName': 'Madaripur'},
                {'Cities': ['Magura'], 'StateName': 'Magura'},
                {'Cities': ['Bhaluka', 'Fulbaria', 'Gafargaon', 'Ishwarganj', 'Maimansingh', 'Muktagachha', 'Trishal'], 'StateName': 'Maimansingh'},
                ...
                {'Cities': ['Gomastapur', 'Nawabganj', 'Shibganj'], 'StateName': 'Nawabganj'},
                {'Cities': ['Netrakona'], 'StateName': 'Netrakona'},
                {'Cities': ['Domar', 'Nilphamari', 'Sa\'idpur'], 'StateName': 'Nilphamari'},
                {'Cities': ['Begamganj', 'Noakhali', 'Senbagh'], 'StateName': 'Noakhali'},
                {'Cities': ['Bera', 'Bhangura', 'Ishurdi', 'Pabna'], 'StateName': 'Pabna'},
                {'Cities': ['Panchagarh'], 'StateName': 'Panchagarh'},
                {'Cities': ['Patuakhali'], 'StateName': 'Patuakhali'},
                {'Cities': ['Bhandaria', 'Mathbaria', 'Nesarabad', 'Pirojpur'], 'StateName': 'Pirojpur'},
                ...
                {'Cities': ['Gopalpur', 'Mirzapur', 'Sakhipur', 'Tangayal'], 'StateName': 'Tangayal'},
                {'Cities': ['Pirganj', 'Thakurgaon'], 'StateName': 'Thakurgaon'}], 'CountryName': 'Bangladesh', 'dial_code': '880', 'code': 'BD'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Saint Thomas'}], 'CountryName': 'Barbados', 'dial_code': '1246', 'code': 'BB'
        },
        {
            'States': [
                {
                ...
                {'Cities': ['Ashmjany', 'Berjozovka', 'Hrodna', 'Lida', 'Masty', 'Navahrudak', 'Shchuchyn', 'Skidel\'', 'Slonim', 'Smarhon\'', 'Vawkavysk'], 'StateName': 'Hrodna'},
                {
                ...
                {'Cities': ['Petrikov'], 'StateName': 'Petrik'},
                {
                    ...
                    'StateName': 'Vicebsk'
                }], 'CountryName': 'Belarus', 'dial_code': '375', 'code': 'BY'
        },
        {
            'States': [
                {
                ...
                {'Cities': ['Alsemberg', 'Asse Zellik', 'Brussels', 'Bruxelles', 'Diegem'], 'StateName': 'Brabant'},
                {'Cities': ['Alsemberg', 'Asse Zellik', 'Brussels', 'Bruxelles', 'Diegem'], 'StateName': 'Brabant Wallon'},
                ...
                {'Cities': ['Callenelle', 'Marcinelle', 'Strepy-Bracquegnies'], 'StateName': 'Wallonne'},
                {
                ...
                }], 'CountryName': 'Belgium', 'dial_code': '32', 'code': 'BE'
        },
        {
            'States': [
                {'Cities': ['Belize', 'San Pedro'], 'StateName': 'Belize'},
                {'Cities': ['Belmopan', 'Benque Viejo', 'San Ignacio'], 'StateName': 'Cayo'},
                {'Cities': ['Corozal'], 'StateName': 'Corozal'},
                {'Cities': [], 'StateName': 'Orange Walk'},
                {'Cities': [], 'StateName': 'Stann Creek'},
                {'Cities': ['Punta Gorda'], 'StateName': 'Toledo'}], 'CountryName': 'Belize', 'dial_code': '501', 'code': 'BZ'
        },
        {
            'States': [
                {'Cities': ['Kandi', 'Malanville'], 'StateName': 'Alibori'},
                {'Cities': ['Batia', 'Boukombe', 'Kouande', 'Natitingou'], 'StateName': 'Atacora'},
                {'Cities': ['Allada', 'Cotonou', 'Ouidah', 'Tanguiete'], 'StateName': 'Atlantique'},
                {'Cities': ['Bembereke', 'Nikki', 'Parakou', 'Tchaourou'], 'StateName': 'Borgou'},
                ...
                {'Cities': ['Athieme', 'Come', 'Grand Popo', 'Lokossa'], 'StateName': 'Mono'},
                {'Cities': ['Adjohoun', 'Porto Novo'], 'StateName': 'Oueme'},
                {'Cities': ['Ketou', 'Pobe', 'Sakete'], 'StateName': 'Plateau'},
                {'Cities': ['Abomey', 'Bohicon', 'Cove', 'Zagnanado'], 'StateName': 'Zou'}], 'CountryName': 'Benin', 'dial_code': '229', 'code': 'BJ'
        },
        {
            'States': [
                {'Cities': ['Hamilton'], 'StateName': 'Hamilton'},
                {'Cities': [], 'StateName': 'Saint George'}], 'CountryName': 'Bermuda', 'dial_code': '1441', 'code': 'BM'
        },
        {
            'States': [
                ...
                {'Cities': ['Wangdiphodrang'], 'StateName': 'Wangdiphodrang'}], 'CountryName': 'Bhutan', 'dial_code': '975', 'code': 'BT'
        },
        {
            'States': [
                {
                ...
                {'Cities': ['Camargo', 'Monteagudo', 'Muyupampa', 'Padilla', 'Sucre', 'Tarabuco', 'Villa Serano'], 'StateName': 'Chuquisaca'},
                {
                ...
                {'Cities': ['Caracollo', 'Challapata', 'Eucaliptus', 'Huanuni', 'Machacamarca', 'Oruro', 'Poopo', 'Santiago de Huari', 'Totoral'], 'StateName': 'Oruro'},
                {'Cities': ['Cobija'], 'StateName': 'Pando'},
                {'Cities': ['Atocha', 'Betanzos', 'Colquechaca', 'Llallagua', 'Potosi', 'Santa Barbara', 'Tupiza', 'Uncia', 'Uyuni', 'Villazon'], 'StateName': 'Potosi'},
                {'Cities': [], 'StateName': 'Santa Cruz'},
                {'Cities': ['Bermejo', 'Entre Rios', 'San Lorenzo', 'Tarija', 'Villamontes', 'Yacuiba'], 'StateName': 'Tarija'}],
            'CountryName': 'Bolivia',
            'dial_code': '591',
            'code': 'BO'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Republika Srpska'}], 'CountryName': 'Bosnia and Herzegovina', 'dial_code': '387', 'code': 'BA'
        },
        {
            'States': [
                ...
                {'Cities': ['Sowa'], 'StateName': 'Sowa'}], 'CountryName': 'Botswana', 'dial_code': '267', 'code': 'BW'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Bouvet Island'}], 'CountryName': 'Bouvet Island'
        },
        {
            'States': [
                {
                ...
                {'Cities': ['Amapa', 'Laranjal do Jari', 'Macapa', 'Mazagao', 'Oiapoque', 'Santana'], 'StateName': 'Amapa'},
                {
                ...
                {'Cities': ['Alto Alegre', 'Boa Vista', 'Bonfim', 'Caracarai', 'Mucajai', 'Normandia', 'Sao Joao da Baliza', 'Sao Luiz'], 'StateName': 'Roraima'},
                ...
                },
                {
                    ...
                    'StateName': 'Tocantins'
                }], 'CountryName': 'Brazil', 'dial_code': '55', 'code': 'BR'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'British Indian Ocean Territory'}], 'CountryName': 'British Indian Ocean Territory', 'dial_code': '246', 'code': 'IO'
        },
        {
            'States': [
                ...
                {'Cities': ['Tutong'], 'StateName': 'Tutong'}], 'CountryName': 'Brunei', 'dial_code': '673', 'code': 'BN'
        },
        {
            'States': [
                {
                ...
                {'Cities': ['Balchik', 'Dobrich', 'General-Toshevo', 'Kavarna', 'Loznica', 'Shabla', 'Tervel'], 'StateName': 'Dobrich'},
                {'Cities': ['Drjanovo', 'Gabrovo', 'Plachkovci', 'Sevlievo', 'Trjavna'], 'StateName': 'Gabrovo'},
                {'Cities': ['Dimitrovgrad', 'Harmanli', 'Haskovo', 'Ivajlovgrad', 'Ljubimec', 'Madzharovo', 'Merichleri', 'Simeonovgrad', 'Svilengrad'], 'StateName': 'Haskovo'},
                {'Cities': ['Boljarovo', 'Elhovo', 'Jambol', 'Straldzha', 'Topolovgrad'], 'StateName': 'Jambol'},
                {'Cities': ['Ardino', 'Dzhebel', 'Kardzhali', 'Krumovgrad', 'Momchilgrad'], 'StateName': 'Kardzhali'},
                {'Cities': ['Boboshevo', 'Bobovdol', 'Dupnica', 'Kjustendil', 'Kocherinovo', 'Rila', 'Sapareva Banja', 'Zemen'], 'StateName': 'Kjustendil'},
                {'Cities': ['Aprilci', 'Jablanica', 'Letnica', 'Lovech', 'Lukovit', 'Sopot', 'Teteven', 'Trojan', 'Ugarchin'], 'StateName': 'Lovech'},
                {'Cities': ['Berkovica', 'Bojchinovci', 'Brusarci', 'Chiprovci', 'Lom', 'Montana', 'Valchedram', 'Varshec'], 'StateName': 'Montana'},
                ...
                {'Cities': ['Bankja', 'Batanovci', 'Breznik', 'Pernik', 'Radomir', 'Tran'], 'StateName': 'Pernik'},
                {
                ...
                {'Cities': ['Isperih', 'Kubrat', 'Razgrad', 'Senovo', 'Zavet'], 'StateName': 'Razgrad'},
                {'Cities': ['Bjala', 'Borovo', 'Dve Mogili', 'Ruse', 'Russe', 'Vetovo'], 'StateName': 'Ruse'},
                {'Cities': ['Kaolinovo', 'Kaspichan', 'Novi Pazar', 'Pliska', 'Shumen', 'Smjadovo', 'Veliki Preslav'], 'StateName': 'Shumen'},
                {'Cities': ['Alfatar', 'Dulovo', 'Glavinica', 'Silistra', 'Tutrakan'], 'StateName': 'Silistra'},
                {'Cities': ['Kermen', 'Kotel', 'Nova Zagora', 'Shivachevo', 'Sliven'], 'StateName': 'Sliven'},
                {'Cities': ['Chepelare', 'Devin', 'Dospat', 'Laki', 'Madan', 'Nedelino', 'Rudozem', 'Smoljan', 'Zlatograd'], 'StateName': 'Smoljan'},
                {'Cities': [], 'StateName': 'Sofija grad'},
                {'Cities': [], 'StateName': 'Sofijska oblast'},
                {'Cities': [], 'StateName': 'Stara Zagora'},
                {'Cities': ['Antonovo', 'Omurtag', 'Opaka', 'Popovo', 'Targovishte'], 'StateName': 'Targovishte'},
                {'Cities': ['Beloslav', 'Bjala', 'Dalgopol', 'Devnja', 'Iskar', 'Provadija', 'Suvorovo', 'Valchi Dol', 'Varna'], 'StateName': 'Varna'},
                {'Cities': [], 'StateName': 'Veliko Tarnovo'},
                {'Cities': ['Belogradchik', 'Bregovo', 'Dimovo', 'Dolni Chiflik', 'Dunavci', 'Gramada', 'Kula', 'Vidin'], 'StateName': 'Vidin'},
                {'Cities': ['Bjala Slatina', 'Knezha', 'Kojnare', 'Kozloduj', 'Krivodol', 'Mezdra', 'Mizija', 'Orjahovo', 'Roman', 'Vraca'], 'StateName': 'Vraca'},
                {'Cities': ['Yablaniza'], 'StateName': 'Yablaniza'}], 'CountryName': 'Bulgaria', 'dial_code': '359', 'code': 'BG'
        },
        {
            'States': [
                ...
                {'Cities': ['Manga'], 'StateName': 'Zoundweogo'}], 'CountryName': 'Burkina Faso', 'dial_code': '226', 'code': 'BF'
        },
        {
            'States': [
                ...
                {'Cities': ['Ruyigi'], 'StateName': 'Ruyigi'}], 'CountryName': 'Burundi', 'dial_code': '257', 'code': 'BI'
        },
        {
            'States': [
                ...
                {'Cities': ['Phumi Takaev'], 'StateName': 'Takaev'}], 'CountryName': 'Cambodia', 'dial_code': '855', 'code': 'KH'
        },
        {
            'States': [
                {'Cities': ['Banyo', 'Meiganga', 'Ngaoundere', 'Tibati', 'Tignere'], 'StateName': 'Adamaoua'},
                {'Cities': ['Akonolinga', 'Bafia', 'Eseka', 'Mbalmayo', 'Mfou', 'Monatele', 'Nanga Eboko', 'Obala', 'Ombesa', 'Saa', 'Yaounde'], 'StateName': 'Centre'},
                {'Cities': ['Abong Mbang', 'Batouri', 'Bertoua', 'Betare Oya', 'Djoum', 'Doume', 'Lomie', 'Yokadouma'], 'StateName': 'Est'},
                {'Cities': ['Bonaberi', 'Dibombari', 'Douala', 'Edea', 'Loum', 'Manjo', 'Mbanga', 'Nkongsamba', 'Yabassi'], 'StateName': 'Littoral'},
                {'Cities': ['Figuif', 'Garoua', 'Guider', 'Lagdo', 'Poli', 'Rey Bouba', 'Tchollire'], 'StateName': 'Nord'},
                {'Cities': ['Figuif', 'Garoua', 'Guider', 'Lagdo', 'Poli', 'Rey Bouba', 'Tchollire'], 'StateName': 'Nord Extreme'},
                {'Cities': ['Bamenda', 'Kumbo', 'Mbengwi', 'Mme', 'Njinikom', 'Nkambe', 'Wum'], 'StateName': 'Nordouest'},
                {'Cities': ['Bafang', 'Bafoussam', 'Bafut', 'Bali', 'Bana', 'Bangangte', 'Djang', 'Fontem', 'Foumban', 'Foumbot', 'Mbouda'], 'StateName': 'Ouest'},
                {'Cities': ['Akom', 'Ambam', 'Ebolowa', 'Kribi', 'Lolodorf', 'Moloundou', 'Mvangue', 'Sangmelima'], 'StateName': 'Sud'},
                {'Cities': ['Buea', 'Idenao', 'Kumba', 'Limbe', 'Mamfe', 'Muyuka', 'Tiko'], 'StateName': 'Sudouest'}], 'CountryName': 'Cameroon', 'dial_code': '237', 'code': 'CM'
        },
        {
            'States': [
                {
                ...
                {'Cities': ['Clyde River', 'Iqaluit', 'Kangerdlinerk', 'Oqsuqtooq', 'Pangnirtung', 'Tununirusiq'], 'StateName': 'Nunavut'},
                {
                ...
                {'Cities': ['Haines Junction', 'Mayo', 'Whitehorse'], 'StateName': 'Yukon'}], 'CountryName': 'Canada', 'dial_code': '1', 'code': 'CA'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Sao Vicente'}], 'CountryName': 'Cape Verde', 'dial_code': '238', 'code': 'CV'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Grand Cayman'}], 'CountryName': 'Cayman Islands', 'dial_code': '345', 'code': 'KY'
        },
        {
            'States': [
                ...
                {'Cities': ['Berberati', 'Carnot', 'Gamboula'], 'StateName': 'Mambere-Kadei'},
                {'Cities': ['Bangassou', 'Gambo', 'Ouango', 'Rafai'], 'StateName': 'Mbomou'},
                {'Cities': ['Kaga-Bandoro'], 'StateName': 'Nana-Gribizi'},
                {'Cities': ['Baboua', 'Baoro', 'Bouar'], 'StateName': 'Nana-Mambere'},
                {'Cities': [], 'StateName': 'Ombella Mpoko'},
                {'Cities': ['Bambari', 'Grimari', 'Ippy', 'Kouango'], 'StateName': 'Ouaka'},
                {'Cities': ['Batangafo', 'Bossangoa', 'Bouca', 'Kabo'], 'StateName': 'Ouham'},
                {'Cities': ['Bocaranga', 'Bozoum', 'Paoua'], 'StateName': 'Ouham-Pende'},
                {'Cities': ['Nola'], 'StateName': 'Sangha-Mbaere'},
                {'Cities': ['Birao'], 'StateName': 'Vakaga'}], 'CountryName': 'Central African Republic', 'dial_code': '236', 'code': 'CF'
        },
        {
            'States': [
                {'Cities': ['Ati', 'Oum Hadjer'], 'StateName': 'Batha'},
                {'Cities': ['Biltine'], 'StateName': 'Biltine'},
                {'Cities': ['Aouzou', 'Bardai', 'Fada', 'Faya'], 'StateName': 'Bourkou-Ennedi-Tibesti'},
                {'Cities': ['Bokoro', 'Bousso', 'Dourbali', 'Massaguet', 'Massakory', 'Massenya', 'N\'Djamena', 'Ngama'], 'StateName': 'Chari-Baguirmi'},
                ...
                {'Cities': ['Bongor', 'Fianga', 'Gounou Gaya', 'Guelengdeng', 'Lere', 'Pala'], 'StateName': 'Mayo-Kebbi'},
                {'Cities': ['Goundi', 'Koumra', 'Kyabe', 'Moissala', 'Sarh'], 'StateName': 'Moyen-Chari'},
                {'Cities': ['Abeche', 'Adre', 'Am Dam'], 'StateName': 'Ouaddai'},
                {'Cities': ['Abou Deia', 'Am Timan', 'Mangueigne'], 'StateName': 'Salamat'},
                {'Cities': ['Benoy', 'Bere', 'Kelo', 'Lai'], 'StateName': 'Tandjile'}], 'CountryName': 'Chad', 'dial_code': '235', 'code': 'TD'
        },
        {
            'States': [
                {'Cities': ['Aisen', 'Chile Chico', 'Cisnes', 'Cochrane', 'Coihaique', 'Guaitecas', 'Lago Verde', 'O\'Higgins', 'Rio Ibanez', 'Tortel'], 'StateName': 'Aisen'},
                {
                ...
                {'Cities': ['Alto del Carmen', 'Caldera', 'Chanaral', 'Copiapo', 'Diego de Almagro', 'Freirina', 'Huasco', 'Tierra Amarilla', 'Vallenar'], 'StateName': 'Atacama'},
                ...
                {'Cities': ['Arica', 'Camarones', 'Camina', 'Colchane', 'General Lagos', 'Huara', 'Iquique', 'Pica', 'Pozo Almonte', 'Putre'], 'StateName': 'Tarapaca'},
                {
                ...
                }], 'CountryName': 'Chile', 'dial_code': '56', 'code': 'CL'
        },
        {
            'States': [
                {'Cities': ['Fengyang', 'Guangde', 'Liuan', 'Ningguo', 'Shucheng', 'Xinchang', 'Xuancheng'], 'StateName': 'Anhui'},
                {'Cities': ['Fengyang', 'Guangde', 'Liuan', 'Ningguo', 'Shucheng', 'Xinchang', 'Xuancheng'], 'StateName': 'Anhui Province'},
                {'Cities': ['Fengyang', 'Guangde', 'Liuan', 'Ningguo', 'Shucheng', 'Xinchang', 'Xuancheng'], 'StateName': 'Anhui Sheng'},
                {'Cities': ['Aomen'], 'StateName': 'Aomen'},
                {'Cities': ['Beijing', 'Changping', 'Fangshan', 'Huangcun', 'Liangxiang', 'Mentougou', 'Shunyi', 'Tongzhou'], 'StateName': 'Beijing'},
                {'Cities': ['Beijing', 'Changping', 'Fangshan', 'Huangcun', 'Liangxiang', 'Mentougou', 'Shunyi', 'Tongzhou'], 'StateName': 'Beijing Shi'},
                {'Cities': ['Beibei', 'Chongqing', 'Fuling', 'Longhua', 'Nantongkuang', 'Wanxian', 'Xiuma', 'Yubei', 'Yudong'], 'StateName': 'Chongqing'},
                {
                ...
                {'Cities': ['Chengmai', 'Dingan', 'Haikou', 'Lingao', 'Qiongshan', 'Sansha ', 'Sanya', 'Wanning'], 'StateName': 'Hainan'},
                {
                ...
                {'Cities': ['Jiading', 'Minhang', 'Shanghai', 'Songjiang', 'Trencin'], 'StateName': 'Shanghai'},
                {
                ...
                {'Cities': ['Beichen', 'Gangdong', 'Hangu', 'Jinghai', 'Nankai', 'Tanggu', 'Tianjin', 'Xianshuigu', 'Yangcun', 'Yangliuqing'], 'StateName': 'Tianjin'},
                {'Cities': ['Guiqing', 'Jiulong', 'Quanwan', 'Saigong', 'Shatin', 'Taipo', 'Tuanmun', 'Xianggang', 'Yuanlong'], 'StateName': 'Xianggang'},
                {
                ...
                }], 'CountryName': 'China', 'dial_code': '86', 'code': 'CN'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Christmas Island'}], 'CountryName': 'Christmas Island', 'dial_code': '61', 'code': 'CX'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Cocos (Keeling) Islands'}], 'CountryName': 'Cocos (Keeling) Islands', 'dial_code': '61', 'code': 'CC'
        },
        {
            'States': [
                ...
                {'Cities': ['Arauca', 'Arauquita', 'Cravo Norte', 'Fortul', 'Puerto Rondon', 'Saravena', 'Tame'], 'StateName': 'Arauca'},
                {
                ...
                {'Cities': ['Calamar', 'El Retorno', 'Miraflores', 'San Jose del Guaviare'], 'StateName': 'Guaviare'},
                {
                ...
                {'Cities': ['Acaricuara', 'Mitu', 'Papunaua', 'Taraira', 'Villa Fatima', 'Yavarate'], 'StateName': 'Vaupes'},
                {'Cities': ['Cumaribo', 'La Primavera', 'Puerto Carreno', 'Santa Rosalia'], 'StateName': 'Vichada'}], 'CountryName': 'Colombia', 'dial_code': '57', 'code': 'CO'
        },
        {
            'States': [
                {'Cities': ['Fomboni'], 'StateName': 'Mwali'},
                {'Cities': ['Mitsamiouli', 'Moroni'], 'StateName': 'Njazidja'},
                {'Cities': ['Domoni', 'Mutsamudu'], 'StateName': 'Nzwani'}], 'CountryName': 'Comoros', 'dial_code': '269', 'code': 'KM'
        },
        {
            'States': [
                {'Cities': ['Loudima', 'Madingou', 'Nkayi'], 'StateName': 'Bouenza'},
                {'Cities': ['Brazzaville'], 'StateName': 'Brazzaville'},
                {'Cities': ['Ewo', 'Kelle', 'Makoua', 'Mossaka', 'Owando'], 'StateName': 'Cuvette'},
                {'Cities': ['Loandjili', 'Ngamaba-Mfilou', 'Pointe Noire'], 'StateName': 'Kouilou'},
                {'Cities': ['Sibiti', 'Zanaga'], 'StateName': 'Lekoumou'},
                {'Cities': ['Dongou', 'Epena', 'Impfondo'], 'StateName': 'Likouala'},
                {'Cities': ['Kibangou', 'Loubomo', 'Matsanga', 'Mossendjo'], 'StateName': 'Niari'},
                {'Cities': ['Djambala', 'Gamboma'], 'StateName': 'Plateaux'},
                {'Cities': ['Boko', 'Kinkala', 'Mindouli'], 'StateName': 'Pool'},
                {'Cities': ['Ikelemba', 'Ouesso', 'Sembe', 'Souanke'], 'StateName': 'Sangha'}], 'CountryName': 'Congo', 'dial_code': '242', 'code': 'CG'
        },
        {
            'States': [
                {
                ...
                {'Cities': ['Boma', 'Kasangulu', 'Kimpese', 'Madimba', 'Matadi', 'Mbanza-Ngungu', 'Muanda', 'Tshela'], 'StateName': 'Bas-Congo'},
                {
                ...
                {'Cities': ['Demba', 'Dibaya', 'Ilebo', 'Kananga', 'Kazumba', 'Luebo', 'Mweka', 'Tshikapa'], 'StateName': 'Kasai-Occidental'},
                {
                ...
                {'Cities': ['Bukavu', 'Kabare', 'Kama', 'Kampene', 'Kibombo', 'Uvira'], 'StateName': 'Sud-Kivu'}],
        ...
        },
        {
            'States': [
                ...
                {'Cities': ['Omoka'], 'StateName': 'Tongareva'}], 'CountryName': 'Cook Islands', 'dial_code': '682', 'code': 'CK'
        },
        {
            'States': [
                {
                ...
                {'Cities': [], 'StateName': 'San Jose'}], 'CountryName': 'Costa Rica', 'dial_code': '506', 'code': 'CR'
        },
        {
            'States': [
                {'Cities': ['Marcory'], 'StateName': 'Abidjan'},
                {'Cities': ['Adzope', 'Affery', 'Agboville', 'Akoupe', 'Rubino'], 'StateName': 'Agneby'},
                {'Cities': ['Touba'], 'StateName': 'Bafing'},
                {'Cities': ['Bako', 'Odienne'], 'StateName': 'Denguele'},
                {'Cities': [], 'StateName': 'Dix-huit Montagnes'},
                {'Cities': ['Gagnoa', 'Guiberoua', 'Hire', 'Ndouci', 'Oume', 'Ouragahio'], 'StateName': 'Fromager'},
                {'Cities': ['Daloa', 'Issia', 'Vavoua'], 'StateName': 'Haut-Sassandra'},
                {'Cities': ['Ndiekro', 'Tiebissou', 'Toumodi', 'Yamoussoukro'], 'StateName': 'Lacs'},
                {'Cities': ['Abidjan', 'Alepe', 'Anyama', 'Bingerville', 'Dabou', 'Grand-Lahou', 'Jacqueville', 'Tiassale'], 'StateName': 'Lagunes'},
                {'Cities': ['Bouafle', 'Sinfra', 'Zuenoula'], 'StateName': 'Marahoue'},
                {'Cities': ['Duekoue', 'Guiglo', 'Toulepleu'], 'StateName': 'Moyen-Cavally'},
                {'Cities': ['Abengourou', 'Agnibilekrou'], 'StateName': 'Moyen-Comoe'},
                {'Cities': ['Arrah', 'Bocanda', 'Bongouanou', 'Daoukro', 'Dimbokro', 'M\'bahiakro', 'Mbatto', 'N\'zi-Comoe'], 'StateName': 'N\'zi-Comoe'},
                {'Cities': ['San-Pedro', 'Sassandra', 'Soubre', 'Tabou'], 'StateName': 'Sassandra'},
                {'Cities': ['Boundiali', 'Dikodougou', 'Ferkessedougou', 'Korhogo', 'Tingrela'], 'StateName': 'Savanes'},
                {'Cities': ['Divo', 'Fresco', 'Lakota'], 'StateName': 'Sud-Bandama'},
                {'Cities': ['Aboisso', 'Adiake', 'Ayame', 'Bonoua', 'Grand Bassam'], 'StateName': 'Sud-Comoe'},
                {'Cities': [], 'StateName': 'Vallee du Bandama'},
                {'Cities': ['Kani', 'Mankono', 'Seguela'], 'StateName': 'Worodougou'},
                {'Cities': ['Bondoukou', 'Bouna', 'Tanda'], 'StateName': 'Zanzan'}], 'CountryName': 'Cote D\'Ivoire (Ivory Coast)', 'dial_code': '225', 'code': 'CI'
        },
        {
            'States': [
                {
                ...
                },
                {
                    ...
                    'StateName': 'Zagreb'
                }], 'CountryName': 'Croatia (Hrvatska)', 'dial_code': '385', 'code': 'HRV'
        },
        {
            'States': [
                {
                ...
                {'Cities': ['Cienfuegos', 'Cruces', 'Cumanayagua', 'Palmira', 'Rodas'], 'StateName': 'Cienfuegos'},
                {'Cities': [], 'StateName': 'Ciudad de la Habana'},
                {'Cities': ['Bayamo', 'Campechuela', 'Guisa', 'Jiguani', 'Manzanillo', 'Media Luna', 'Niquero', 'Pilon', 'Rio Cauto', 'Yara'], 'StateName': 'Granma'},
                {'Cities': ['Baracoa', 'Guantanamo', 'Yateras'], 'StateName': 'Guantanamo'},
                {'Cities': ['Havana'], 'StateName': 'Habana'},
                {'Cities': ['Antilla', 'Baguanos', 'Banes', 'Cacocum', 'Cauto Cristo', 'Cueto', 'Gibara', 'Holguin', 'Jobabo', 'Moa', 'Sagua de Tanamo'], 'StateName': 'Holguin'},
                ...
                {'Cities': [], 'StateName': 'Villa Clara'}], 'CountryName': 'Cuba', 'dial_code': '53', 'code': 'CU'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Turkish controlled area'}], 'CountryName': 'Cyprus', 'dial_code': '537', 'code': 'CY'
        },
        {
            'States': [
                ...
                {
                    'Cities': ['Bilina', 'Chomutov', 'Dechin', 'Dubi', 'Duchcov', 'Jilove', 'Jirkov', 'Kadan', 'Klasterec nad Ohri', 'Krupka', 'Litomerice', 'Litvinov', 'Louny', 'Lovosice', 'Mezibori', 'Most', 'Osek', 'Podborany', 'Roudnice', 'Rumburk', 'Shluknov', 'Shteti', 'Teplice', 'Usti', 'Varnsdorf', 'Zatec'],
                    'StateName': 'Ustecky'
                },
                ...
                },
                {
                    ...
                    'StateName': 'Zlinsky'
                }], 'CountryName': 'Czech Republic', 'dial_code': '420', 'code': 'CZ'
        },
        {
            'States': [
                {
                ...
                {'Cities': ['Aakirkeby', 'Allinge-Sandvig', 'Nexo', 'Ronne'], 'StateName': 'Bornholm'},
                {
                ...
                {'Cities': ['Ballerup', 'Brondby', 'Stenlose', 'Vallensbaek'], 'StateName': 'Hovedstaden'},
                {
                ...
                },
                {
                    ...
                    'StateName': 'Viborg'
                }], 'CountryName': 'Denmark', 'dial_code': '45', 'code': 'DK'
        },
        {
            'States': [
                ...
                {'Cities': ['Ubuk'], 'StateName': 'Ubuk'}], 'CountryName': 'Djibouti', 'dial_code': '253', 'code': 'DJ'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Saint Andrew'},
                ...
                {'Cities': [], 'StateName': 'Saint Peter'}], 'CountryName': 'Dominica', 'dial_code': '1767', 'code': 'DM'
        },
        {
            'States': [
                ...
                {'Cities': ['Las Guaranas', 'Pimentel', 'San Francisco de Macoris'], 'StateName': 'Duarte'},
                ...
                {'Cities': ['Santiago', 'Tamboril', 'Villa Bisono'], 'StateName': 'Santiago'},
                {'Cities': ['Santiago', 'Tamboril', 'Villa Bisono'], 'StateName': 'Santiago Rodriguez'},
                {'Cities': ['Esperanza', 'Mao'], 'StateName': 'Valverde'}], 'CountryName': 'Dominican Republic', 'dial_code': '1849', 'code': 'DO'
        },
        {
            'States': [
                ...
                {'Cities': ['Viqueque'], 'StateName': 'Viqueque'}], 'CountryName': 'East Timor'
        },
        {
            'States': [
                ...
                {'Cities': ['La Mana', 'Latacunga', 'Pujili', 'San Miguel', 'Saquisili'], 'StateName': 'Cotopaxi'},
                {'Cities': [], 'StateName': 'El Oro'},
                {'Cities': ['Esmeraldas', 'Muisne', 'Rosa Zarate', 'San Lorenzo', 'Valdez'], 'StateName': 'Esmeraldas'},
                {'Cities': ['Puerto Ayora', 'Puerto Baquerizo Moreno', 'San Cristobal'], 'StateName': 'Galapagos'},
                {
                ...
                {'Cities': ['Atuntaqui', 'Cotacachi', 'Ibarra', 'Otavalo', 'Pimampiro'], 'StateName': 'Imbabura'},
                {'Cities': ['Alamor', 'Cariamanga', 'Catacocha', 'Catamayo', 'Celica', 'Loja', 'Macara'], 'StateName': 'Loja'},
                ...
                {'Cities': ['Cayambe', 'Machachi', 'Quito', 'Sangolqui', 'Santo Domingo'], 'StateName': 'Pichincha'},
                {'Cities': ['Nueva Loja', 'Shushufindi'], 'StateName': 'Sucumbios'},
                {'Cities': ['Ambato', 'Banos', 'Pelileo', 'Pillaro'], 'StateName': 'Tungurahua'},
                {'Cities': [], 'StateName': 'Zamora Chinchipe'}], 'CountryName': 'Ecuador', 'dial_code': '593', 'code': 'EC'
        },
        {
            'States': [
                {'Cities': ['Aswan', 'Daraw', 'Kawm Umbu', 'an-Nasir'], 'StateName': 'Aswan'},
                {
                ...
                {'Cities': ['6th of October City', 'Ataba', 'Cairo', 'Nasr', 'Nasr City', 'Obour City'], 'StateName': 'Cairo'},
                {'Cities': ['\'Izbat-al-Burj', 'Damietta', 'Dumyat', 'El-Zarka', 'Faraskur', 'Kafr Sa\'d', 'Kafr-al-Battikh', 'az-Zarqa'], 'StateName': 'Dumyat'},
                {
                ...
                {'Cities': ['Marsa Matruh', 'Nasr', 'Sidi Barrani', 'Zawiyat Shammas', 'ad-Da\'ba'], 'StateName': 'Matruh'},
                ...
                {'Cities': ['Ras Gharib', 'Safaja', 'al-Ghardaqah', 'al-Qusayr'], 'StateName': 'al-Bahr-al-Ahmar'},
                {
                ...
                {'Cities': ['Fidimin', 'Ibshaway', 'Itsa', 'Qasr Qarun', 'Sanhur', 'Sinnuris', 'Tamiyah', 'al-Fayyum'], 'StateName': 'al-Fayyum'},
                {
                ...
                {'Cities': ['Agamy', 'al-Iskandariyah', 'al-Maks'], 'StateName': 'al-Iskandariyah'},
                {'Cities': ['Fa\'id', 'Sarabiyum', 'al-Ismailiyah'], 'StateName': 'al-Ismailiyah'},
                {
                ...
                {'Cities': ['Badr City', 'Heliopolis', 'al-Qahira'], 'StateName': 'al-Qahira'},
                {
                ...
                }], 'CountryName': 'Egypt', 'dial_code': '20', 'code': 'EG'
        },
        {
            'States': [
                {'Cities': ['Ahuachapan', 'Atiquizaya', 'Concepcion de Ataco', 'Guaymango', 'Jujutla', 'San Francisco Menendez', 'Tacuba'], 'StateName': 'Ahuachapan'},
                {'Cities': ['Ilobasco', 'Sensuntepeque', 'Victoria'], 'StateName': 'Cabanas'},
                {'Cities': ['Chalatenango', 'La Palma', 'Nueva Concepcion', 'San Francisco Morazan'], 'StateName': 'Chalatenango'},
                {'Cities': ['Cojutepeque', 'San Pedro Perulapan', 'Suchitoto', 'Tecoluca', 'Tenancingo'], 'StateName': 'Cuscatlan'},
                {'Cities': [], 'StateName': 'La Libertad'},
                {'Cities': [], 'StateName': 'La Paz'},
                {'Cities': [], 'StateName': 'La Union'},
                {'Cities': ['Cacaopera', 'Corinto', 'Gotera', 'Guatajiagua', 'Jocoro', 'Sociedad'], 'StateName': 'Morazan'},
                {'Cities': [], 'StateName': 'San Miguel'},
                {'Cities': [], 'StateName': 'San Salvador'},
                {'Cities': [], 'StateName': 'San Vicente'},
                {'Cities': [], 'StateName': 'Santa Ana'},
                {'Cities': ['Acajutla', 'Armenia', 'Izalco', 'Juayua', 'Nahuizalco', 'San Antonio del Monte', 'San Julian', 'Sonsonate', 'Sonzacate'], 'StateName': 'Sonsonate'},
                {
                    ...
                    'StateName': 'Usulutan'
                }], 'CountryName': 'El Salvador', 'dial_code': '503', 'code': 'SV'
        },
        {
            'States': [
                ...
                {'Cities': ['Aconibe', 'Anisoc', 'Mongomo', 'Nsok'], 'StateName': 'Wele-Nzas'}], 'CountryName': 'Equatorial Guinea', 'dial_code': '240', 'code': 'GQ'
        },
        {
            'States': [
                {'Cities': ['Keren'], 'StateName': 'Anseba'},
                {'Cities': ['Addi Kwala', 'Addi Ugri'], 'StateName': 'Debub'},
                {'Cities': ['Asseb', 'Beylul', 'Edd', 'Mersa Fatma'], 'StateName': 'Debub-Keih-Bahri'},
                {'Cities': ['Ak\'ordat', 'Barentu', 'Teseney'], 'StateName': 'Gash-Barka'},
                {'Cities': ['Asmara', 'Ginda', 'Himbirti', 'Nefasit'], 'StateName': 'Maekel'},
                {'Cities': ['Addi K\'eyih', 'Dek\'emhare', 'Mitsiwa', 'Sen\'afe'], 'StateName': 'Semien-Keih-Bahri'}], 'CountryName': 'Eritrea', 'dial_code': '291', 'code': 'ER'
        },
        {
            'States': [
                {
                ...
                {'Cities': ['Emmaste', 'Jausa', 'Kaina', 'Kardla', 'Korgessaare', 'Lauka', 'Lope', 'Mannamaa', 'Putkaste', 'Suuremoisa'], 'StateName': 'Hiiu'},
                {
                ...
                },
                {
                    ...
                    'StateName': 'Voru'
                }], 'CountryName': 'Estonia', 'dial_code': '372', 'code': 'EE'
        },
        {
            'States': [
                ...
                {'Cities': ['Bircot', 'Degeh Bur', 'Dollo Odo', 'Imi', 'Jijiga', 'Werder'], 'StateName': 'Somali'},
                {
                ...
                },
                {
                    ...
                    'StateName': 'Tigray'
                }], 'CountryName': 'Ethiopia', 'dial_code': '251', 'code': 'ET'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Christmas Island'},
                {'Cities': [], 'StateName': 'Cocos Islands'},
                {'Cities': [], 'StateName': 'Coral Sea Islands'}], 'CountryName': 'External Territories of Australia', 'dial_code': '672', 'code': 'AU-ACT'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Falkland Islands'},
                {'Cities': [], 'StateName': 'South Georgia'}], 'CountryName': 'Falkland Islands', 'dial_code': '500', 'code': 'FK'
        },
        {
            'States': [
                ...
                {'Cities': ['Husavik', 'Sands', 'Skalavik', 'Skopun', 'Skuvoy'], 'StateName': 'Sandoy'},
                {'Cities': ['Haldarsvik', 'Hests', 'Hosvik', 'Hvalvik', 'Kirkjubo', 'Kollafjar ', 'Kvivik', 'Nolsoy', 'Saksun', 'Torshavn', 'Vestmanna'], 'StateName': 'Streymoy'},
                {'Cities': [], 'StateName': 'Su uroy'},
                {'Cities': [], 'StateName': 'Sy ra Eysturoy'},
                {'Cities': ['Torshavn'], 'StateName': 'Torshavn'},
                {'Cities': ['Biggjar', 'Midvags', 'Mykines', 'Sandavags', 'Sorvags'], 'StateName': 'Vaga'}], 'CountryName': 'Faroe Islands', 'dial_code': '298', 'code': 'FO'
        },
        {
            'States': [
                {'Cities': ['Deuba', 'Korovou', 'Lami', 'Namosi', 'Nausori', 'Navua', 'Suva'], 'StateName': 'Central'},
                {'Cities': ['Levuka', 'Malhaha', 'Tubou', 'Vunisea'], 'StateName': 'Eastern'},
                {'Cities': ['Korokade', 'Labasa', 'Savusavu'], 'StateName': 'Northern'},
                {'Cities': [], 'StateName': 'South Pacific'},
                {'Cities': ['Ba', 'Lautoka', 'Nadi', 'Rakiraki', 'Sigatoka', 'Tavua', 'Vatukoula'], 'StateName': 'Western'}],
        ...
        },
        {
            'States': [
                ...
                {'Cities': ['Imatra', 'Joutseno', 'Lappeenranta'], 'StateName': 'Etela-Karjala'},
                {'Cities': ['Hyllykallio', 'Ilmajoki', 'Kauhajoki', 'Kurikka', 'Lapua', 'Seinajoki'], 'StateName': 'Etela-Pohjanmaa'},
                {'Cities': ['Mikkeli', 'Savonlinna'], 'StateName': 'Etela-Savo'},
                {'Cities': [], 'StateName': 'Etela-Suomen Laani'},
                {'Cities': [], 'StateName': 'Ita-Suomen Laani'},
                {'Cities': ['Loviisa', 'Orimattila', 'Porvoo'], 'StateName': 'Ita-Uusimaa'},
                {'Cities': ['Kajaani'], 'StateName': 'Kainuu'},
                {'Cities': ['Forssa', 'Hameenlinna', 'Janakkala', 'Riihimaki'], 'StateName': 'Kanta-Hame'},
                {'Cities': ['Kokkola'], 'StateName': 'Keski-Pohjanmaa'},
                {'Cities': ['Aanekoski', 'Jamsa', 'Jyvaskyla', 'Keuruu', 'Laukaa', 'Lieto'], 'StateName': 'Keski-Suomi'},
                {'Cities': ['Anjalankoski', 'Hamina', 'Kotka', 'Kouvola', 'Kuusankoski', 'Valkeala', 'Vehkalahti'], 'StateName': 'Kymenlaakso'},
                {'Cities': [], 'StateName': 'Lansi-Suomen Laani'},
                {'Cities': ['Kemi', 'Kemijarvi', 'Rovaniemi', 'Sonka', 'Tornio'], 'StateName': 'Lappi'},
                {'Cities': [], 'StateName': 'Northern Savonia'},
                {'Cities': ['Jakobstad', 'Oulunsalo'], 'StateName': 'Ostrobothnia'},
                {'Cities': [], 'StateName': 'Oulun Laani'},
                {'Cities': ['Heinola', 'Hollola', 'Lahti', 'Nastola'], 'StateName': 'Paijat-Hame'},
                {'Cities': ['Kangasala', 'Lempaala', 'Nokia', 'Pirkkala', 'Sastamala', 'Tampere', 'Valkeakoski', 'Ylojarvi'], 'StateName': 'Pirkanmaa'},
                {'Cities': ['Kristiinankaupunki', 'Mustasaari', 'Pietarsaari', 'Uusikarlepyy', 'Vaasa'], 'StateName': 'Pohjanmaa'},
                {'Cities': ['Joensuu', 'Lieksa'], 'StateName': 'Pohjois-Karjala'},
                {'Cities': ['Haukipudas', 'Kempele', 'Kuusamo', 'Muhos', 'Nivala', 'Oulainen', 'Oulu', 'Raahe', 'Ylivieska'], 'StateName': 'Pohjois-Pohjanmaa'},
                {'Cities': ['Iisalmi', 'Kuopio', 'Sillinjarvi', 'Varkaus'], 'StateName': 'Pohjois-Savo'},
                ...
                {'Cities': ['Kaarina', 'Naantali', 'Parainen', 'Raisio', 'Salo', 'Turku', 'Uusikaupunki'], 'StateName': 'Varsinais-Suomi'}],
            'CountryName': 'Finland',
            'dial_code': '358',
            'code': 'FI'
        },
        {
            'States': [
                {'Cities': ['Amberieu-en-Bugey', 'Bellegarde-sur-Valserine', 'Bourg-en-Bresse', 'Oyonnax'], 'StateName': 'Ain'},
                {'Cities': ['Chateau-Thierry', 'Chauny', 'Hirson', 'Laon', 'Saint-Quentin', 'Soissons', 'Strassbourg', 'Tergnier'], 'StateName': 'Aisne'},
                {'Cities': [], 'StateName': 'Albi Le Sequestre'},
                {'Cities': ['Cusset', 'Montlucon', 'Moulins', 'Vichy', 'Yzeure'], 'StateName': 'Allier'},
                ...
                {'Cities': ['Annonay', 'Aubenas', 'Guilherand-Granges', 'Privas', 'Tournon-sur-Rhone'], 'StateName': 'Ardeche'},
                {'Cities': ['Charleville-Mezieres', 'Les Hautes-Rivieres', 'Revin', 'Sedan'], 'StateName': 'Ardennes'},
                {'Cities': ['Foix', 'Pamier'], 'StateName': 'Ariege'},
                {'Cities': ['Bar-sur-Seine', 'Romilly-sur-Seine', 'Saint-Andre-les-Vergers', 'Sainte-Savine', 'Troyes'], 'StateName': 'Aube'},
                {'Cities': ['Carcassonne', 'Castelnaudary', 'Limoux', 'Narbonne'], 'StateName': 'Aude'},
                {
                ...
                {'Cities': ['Millau', 'Onet-le-Chataeu', 'Rodez', 'Villefranche-de-Rouergue'], 'StateName': 'Aveyron'},
                {
                ...
                {'Cities': ['Brehan', 'Broons', 'Guipry', 'Miniac-Morvan', 'Ploudaniel', 'Vern-sur-Seiche'], 'StateName': 'Brittany'},
                {'Cities': ['Aillant-sur-Tholon'], 'StateName': 'Burgundy'},
                {'Cities': ['Bayeux', 'Caen', 'Herouville-Saint-Clair', 'Lisieux', 'Mondeville', 'Vire'], 'StateName': 'Calvados'},
                {'Cities': ['Aurillac'], 'StateName': 'Cantal'},
                {'Cities': ['Brumath', 'Courtaboeuf', 'Iregny', 'cedex'], 'StateName': 'Cedex'},
                {
                ...
                {'Cities': ['Angouleme', 'Cognac', 'Lencloitre', 'Soyaux'], 'StateName': 'Charente'},
                {'Cities': ['La Rochelle', 'Rochefort', 'Royan', 'Saintes'], 'StateName': 'Charente-Maritime'},
                {'Cities': ['Bourges', 'Saint-Amand-Montrond', 'Saint-Doulchard', 'Vierzon'], 'StateName': 'Cher'},
                {'Cities': ['Brive-la-Gaillarde', 'Tulle', 'Ussel'], 'StateName': 'Correze'},
                {'Cities': ['Ajaccio', 'Porto-Vecchio'], 'StateName': 'Corse-du-Sud'},
                {'Cities': ['Beaune', 'Chenove', 'Dijon', 'Quetigny', 'Talant'], 'StateName': 'Cote-d\'Or'},
                {'Cities': ['Dinan', 'Lamballe', 'Lannion', 'Loudeac', 'Plerin', 'Ploufragan', 'Saint-Brieuc'], 'StateName': 'Cotes-d\'Armor'},
                {'Cities': ['Gueret'], 'StateName': 'Creuse'},
                {'Cities': ['Crolles'], 'StateName': 'Crolles'},
                {'Cities': ['Bressuire', 'Niort', 'Parthenay', 'Thouars'], 'StateName': 'Deux-Sevres'},
                {'Cities': ['Bergerac', 'Perigueux', 'Sarlat-la-Caneda'], 'StateName': 'Dordogne'},
                {'Cities': ['Audincourt', 'Besancon', 'Beure', 'Montbeliard', 'Pontarlier', 'Valentigney'], 'StateName': 'Doubs'},
                {'Cities': ['Bourg-les-Valence', 'Montelimar', 'Pierrelatte', 'Romans-sur-Isere', 'Valence'], 'StateName': 'Drome'},
                {
                ...
                {'Cities': ['Bernay', 'Evreux', 'Gisors', 'Louviers', 'Pont-Audemer', 'Val-de-Reuil', 'Vernon'], 'StateName': 'Eure'},
                {'Cities': ['Chartres', 'Chateaudun', 'Dreux', 'Luce', 'Mainvillier', 'Nogent-le-Rotrou', 'Vernouillet'], 'StateName': 'Eure-et-Loir'},
                ...
                {'Cities': ['Charquemont', 'Chemaudin', 'Pelousey', 'Perrigny', 'Pirey', 'Villers-le-Lac'], 'StateName': 'Franche-Comte'},
                {'Cities': ['Ales', 'Bagnols-sur-Ceze', 'Beaucaire', 'Nimes', 'Pont-Saint-Esprit', 'Saint-Gilles', 'Vauvert', 'Villeneuve-les-Avignon'], 'StateName': 'Gard'},
                ...
                {'Cities': ['Chaumont', 'Langres', 'Saint-Dizier'], 'StateName': 'Haute-Marne'},
                {'Cities': ['Hericourt', 'Lure', 'Luxeuil-les-Bains', 'Vesoul'], 'StateName': 'Haute-Saone'},
                {
                ...
                {'Cities': ['Gaillard', 'Limoges', 'Saint-Junien'], 'StateName': 'Haute-Vienne'},
                ...
                {'Cities': ['Agde', 'Beziers', 'Castelnau-le-Lez', 'Frontignan', 'Lattes', 'Lunel', 'Mauguio', 'Montpellier', 'Sete'], 'StateName': 'Herault'},
                {
                ...
                {'Cities': ['Cesson-Sevigne', 'Dinard', 'Fougeres', 'Rennes', 'Saint-Malo', 'Vitre'], 'StateName': 'Ille-et-Vilaine'},
                {'Cities': ['Chateauroux', 'Issoudun'], 'StateName': 'Indre'},
                {'Cities': ['Amboise', 'Joue-les-Tours', 'Saint-Avertin', 'Saint-Cyr-sur-Loire', 'Saint-Pierre-des-Corps', 'Tours'], 'StateName': 'Indre-et-Loire'},
                {
                ...
                {'Cities': ['Champagnole', 'Dole', 'Lons-le-Saunier', 'Saint-Claude'], 'StateName': 'Jura'},
                {'Cities': ['Sebastiangasse'], 'StateName': 'Klagenfurt'},
                {'Cities': ['Biscarrosse', 'Dax', 'Hagetmau', 'Landes', 'Mont-de-Marsan', 'Saint-Paul-les-Dax', 'Tarnos'], 'StateName': 'Landes'},
                {'Cities': ['Codolet', 'Cuxac-d\'Aude', 'Gigean', 'Grabels', 'Lamalou-les-Bains', 'Perols', 'Peyrens', 'Tuchan'], 'StateName': 'Languedoc-Roussillon'},
                {'Cities': ['Larcay'], 'StateName': 'Larcay'},
                {'Cities': [], 'StateName': 'Le Castellet'},
                {'Cities': [], 'StateName': 'Le Creusot'},
                {'Cities': ['Voutezac'], 'StateName': 'Limousin'},
                {'Cities': ['Blois', 'Romorantin-Lanthenay', 'Vendome'], 'StateName': 'Loir-et-Cher'},
                {
                ...
                {'Cities': ['Agen', 'Le Passage', 'Marmande', 'Tonneins', 'Villeneuve-sur-Lot'], 'StateName': 'Lot-et-Garonne'},
                {'Cities': [], 'StateName': 'Lower Normandy'},
                {'Cities': ['Mende'], 'StateName': 'Lozere'},
                {'Cities': ['Angers', 'Avrille', 'Cholet', 'Les Ponts-de-Ce', 'Saint-Barthelemy-d\'Anjou', 'Saumur', 'Torfou', 'Trelaze'], 'StateName': 'Maine-et-Loire'},
                {'Cities': ['Cherbourg', 'Coutances', 'Equeurdreville-Hainneville', 'Granville', 'Octeville', 'Saint-Lo', 'Tourlaville'], 'StateName': 'Manche'},
                {'Cities': ['Chalons-en-Champagne', 'Epernay', 'Reims', 'Tinqueux', 'Vitry-le-Francois'], 'StateName': 'Marne'},
                {'Cities': ['Chateau-Gontier', 'Laval', 'Mayenne', 'Montsurs'], 'StateName': 'Mayenne'},
                {
                ...
                {'Cities': ['Boissezon', 'Hauterive', 'Launaguet', 'Mauleon', 'Maurens-Scopont'], 'StateName': 'Midi-Pyrenees'},
                {'Cities': ['Auray', 'Guidel', 'Hennebont', 'Lanester', 'Lorient', 'Ploemeur', 'Pontivy', 'Vannes'], 'StateName': 'Morbihan'},
                {
                ...
                {'Cities': ['Cosne-Cours-sur-Loire', 'Nevers', 'Varennes-Vauzelles'], 'StateName': 'Nievre'},
                {
                ...
                {'Cities': ['Alencon', 'Argentan', 'Flers', 'L\'Aigle'], 'StateName': 'Orne'},
                ...
                {
                    'Cities': ['Loiron', 'Marolles-les-Braults', 'Mortagne-sur-Sevre', 'Mouzillon', 'Noirmoutier-en-l\'\u00c3\u0083\u00c6\u0092\u00c3\u0082\u00c5\u00bdle'],
                    'StateName': 'Pays-de-la-Loire'
                },
                {'Cities': ['Friville', 'Liancourt', 'Maizy', 'Oust-Marest', 'Puiseux-le-Hauberger', 'Saint-Crepin-Ibouvillers'], 'StateName': 'Picardy'},
                {'Cities': ['Aubiere', 'Beaumont', 'Chamalieres', 'Clermont-Ferrand', 'Cournon-d\'Auvergne', 'Gerzat', 'Issoire', 'Riom', 'Thiers'], 'StateName': 'Puy-de-Dome'},
                {
                ...
                {'Cities': ['Perpignan', 'Saint-Esteve'], 'StateName': 'Pyrenees-Orientales'},
                ...
                {'Cities': ['Allonnes', 'La Ferte-Bernard', 'La Fleche', 'Le Mans', 'Sable-sur-Sarthe'], 'StateName': 'Sarthe'},
                {'Cities': ['Aix-les-Bains', 'Albertville', 'Chambery', 'La Motte-Servolex', 'Saint-Jean-de-Maurienne'], 'StateName': 'Savoie'},
                {
                ...
                {'Cities': ['Albi', 'Carmaux', 'Castres', 'Gaillac', 'Graulhet', 'Mazamet'], 'StateName': 'Tarn'},
                {'Cities': ['Castelsarassin', 'Moissac', 'Montauban'], 'StateName': 'Tarn-et-Garonne'},
                ...
                {'Cities': ['Epinal', 'Gerardmer', 'Remiremont', 'Saint-Die'], 'StateName': 'Vosges'},
                {'Cities': ['Auxerre', 'Avallon', 'Joigny', 'Sens'], 'StateName': 'Yonne'},
                {
                    ...
                    'StateName': 'Yvelines'
                }], 'CountryName': 'France', 'dial_code': '33', 'code': 'FR'
        },
        {
            'States': [
                {'Cities': ['Camopi', 'Cayenne', 'Iracoubo', 'Kourou', 'Macouria', 'Matoury', 'Remire-Montjoly', 'Roura', 'Saint-Georges', 'Sinnamary'], 'StateName': 'Cayenne'},
                {'Cities': ['Apatou', 'Grand-Santi', 'Mana', 'Maripasoula', 'Saint-Laurent-du-Maroni'], 'StateName': 'Saint-Laurent-du-Maroni'}],
        ...
        },
        {
            'States': [
                ...
                {'Cities': ['Atuona', 'Fatu-Hiva', 'Hakahao', 'Hakamaii', 'Hatiheu', 'Tahuata', 'Taiohae', 'Taipivai', 'Ua-Huka'], 'StateName': 'Marquesas'},
                {
                ...
                },
                {
                    ...
                    'StateName': 'Tubuai'
                }], 'CountryName': 'French Polynesia', 'dial_code': '689', 'code': 'PF'
        },
        {
            'States': [
                {'Cities': ['Martin-de-Vivies'], 'StateName': 'Amsterdam'},
                {'Cities': [], 'StateName': 'Crozet Islands'},
                {'Cities': ['Port-aux-Francais'], 'StateName': 'Kerguelen'}], 'CountryName': 'French Southern Territories', 'dial_code': '260', 'code': 'ATF'
        },
        {
            'States': [
                {'Cities': ['Cocobeach', 'Kango', 'Libreville', 'Nkan', 'Ntoum'], 'StateName': 'Estuaire'},
                {'Cities': ['Lekoni', 'Masuku', 'Moanda', 'Mounana', 'Okandja'], 'StateName': 'Haut-Ogooue'},
                {'Cities': ['Lambarene', 'Ndjole'], 'StateName': 'Moyen-Ogooue'},
                {'Cities': ['Fougamou', 'Mbigou', 'Mimongo', 'Mouila', 'Ndende'], 'StateName': 'Ngounie'},
                ...
                {'Cities': ['Gamba', 'Omboue', 'Port-Gentil', 'Sette Cama'], 'StateName': 'Ogooue-Maritime'},
                {'Cities': ['Bitam', 'Lalara', 'Medouneu', 'Minvoul', 'Mitzic', 'Oyem'], 'StateName': 'Woleu-Ntem'}], 'CountryName': 'Gabon', 'dial_code': '241', 'code': 'GA'
        },
        {
            'States': [
                {'Cities': ['Banjul'], 'StateName': 'Banjul'},
                {'Cities': ['Basse', 'Gambissara', 'Sabi', 'Salikeni'], 'StateName': 'Basse'},
                {'Cities': ['Brikama', 'Brufut', 'Gunjur', 'Sukuta'], 'StateName': 'Brikama'},
                {'Cities': ['Bansang', 'Janjanbureh'], 'StateName': 'Janjanbureh'},
                {'Cities': ['Bakau', 'Serekunda'], 'StateName': 'Kanifing'},
                {'Cities': ['Barra', 'Essau', 'Farafenni', 'Kerewan', 'Lamin'], 'StateName': 'Kerewan'},
                {'Cities': ['Kuntaur'], 'StateName': 'Kuntaur'},
                {'Cities': ['Mansakonko'], 'StateName': 'Mansakonko'}], 'CountryName': 'Gambia The', 'dial_code': '220', 'code': 'GM'
        },
        {
            'States': [
                {'Cities': ['Ahali Atoni', 'Bihvinta', 'Gagra', 'Gali', 'Gudauta', 'Gulripshi', 'Ochamchira', 'Suhumi', 'Tkvarcheli'], 'StateName': 'Abhasia'},
                {'Cities': ['Batumi', 'Dioknisi', 'Kobuleti', 'Mahindzhauri'], 'StateName': 'Ajaria'},
                {'Cities': ['Lanchhuti', 'Ozurgeti'], 'StateName': 'Guria'},
                {'Cities': ['Bagdadi', 'Chaltubo', 'Chiatura', 'Honi', 'Kutaisi', 'Sachhere', 'Samtredia', 'Terzhola', 'Tkibuli', 'Vani', 'Zestaponi'], 'StateName': 'Imereti'},
                {'Cities': ['Ahmeta', 'Cnori', 'Dedoplisckaro', 'Gurdzhaani', 'Kvareli', 'Lagodehi', 'Sagaredzho', 'Signahi', 'Telavi'], 'StateName': 'Kaheti'},
                ...
                {'Cities': ['Ahalcihe', 'Ahalkalaki', 'Borzhomi', 'Ninocminda', 'Vale'], 'StateName': 'Samche-Zhavaheti'},
                {'Cities': [], 'StateName': 'Shida Kartli'},
                {'Cities': ['Tbilisi'], 'StateName': 'Tbilisi'}], 'CountryName': 'Georgia', 'dial_code': '995', 'code': 'GE'
        },
        {
            'States': [
                ...
                {'Cities': ['Schlobborn'], 'StateName': 'schlobborn'}], 'CountryName': 'Germany', 'dial_code': '49', 'code': 'DE'
        },
        {
            'States': [
                {'Cities': ['Agogo', 'Bekwai', 'Konongo', 'Kumasi', 'Mampong', 'Mankranso', 'Obuasi', 'Ofinso', 'Tafo'], 'StateName': 'Ashanti'},
                {'Cities': ['Bechem', 'Berekum', 'Duayaw Nkwanta', 'Kintampo', 'Sunyani', 'Techiman', 'Wenchi'], 'StateName': 'Brong-Ahafo'},
                {
                ...
                {'Cities': ['Kpandae', 'Salaga', 'Savelugu', 'Tamale', 'Yendi'], 'StateName': 'Northern'},
                {'Cities': [], 'StateName': 'Upper East'},
                {'Cities': [], 'StateName': 'Upper West'},
                {'Cities': ['Aflao', 'Anloga', 'Ho', 'Hohoe', 'Keta', 'Kete-Krachi', 'Kpandu'], 'StateName': 'Volta'},
                {'Cities': ['Aboso', 'Anomabu', 'Axim', 'Bibiani', 'Prestea', 'Sekondi', 'Shama', 'Takoradi', 'Tarkwa'], 'StateName': 'Western'}],
            'CountryName': 'Ghana',
            'dial_code': '233',
            'code': 'GH'
        },
        {
            'States': [
                {'Cities': ['Gibraltar'], 'StateName': 'Gibraltar'}], 'CountryName': 'Gibraltar', 'dial_code': '350', 'code': 'GI'
        },
        {
            'States': [
                ...
                {'Cities': ['Acharnes', 'Agios Ioannis Rentis', 'Drapetsona', 'Koropi', 'Lavrion', 'Mandra', 'Spata'], 'StateName': 'Attica'},
                {
                ...
                {'Cities': ['Arhangelos', 'Ialysos', 'Kos', 'Rodos'], 'StateName': 'Dodekanisos'},
                ...
                {'Cities': ['Lakkoma', 'N. Kallikrateia', 'Poliyiros'], 'StateName': 'Halkidiki'},
                ...
                {'Cities': ['Ayios Nikolaos', 'Ierapetra', 'Sitia'], 'StateName': 'Lasithi'},
                ...
                {'Cities': ['Ampelokipa', 'Kalamaria', 'Neapoli', 'Oristiada', 'Thessaloniki'], 'StateName': 'Thessaloniki'},
                ...
                {'Cities': ['Zakinthos'], 'StateName': 'Zakinthos'}], 'CountryName': 'Greece', 'dial_code': '30', 'code': 'GR'
        },
        {
            'States': [
                {'Cities': ['Aasiaat', 'Akunnaaq', 'Kitsissuarsuit'], 'StateName': 'Aasiaat'},
                {'Cities': ['Ikkatteq', 'Isortoq', 'Kulusuk', 'Kuumiut', 'Qernertuarssuit', 'Sermiligaaq', 'Tasiilaq', 'Tiniteqilaaq'], 'StateName': 'Ammassalik'},
                {'Cities': ['Illoqqortoormiut', 'Itterajivit', 'Uunarteq'], 'StateName': 'Illoqqortoormiut'},
                {'Cities': ['Ilimanaq', 'Ilulissat', 'Oqaatsut', 'Qeqertaq', 'Saqqaq'], 'StateName': 'Ilulissat'},
                {'Cities': ['Ivittuut', 'Kangilinnguit'], 'StateName': 'Ivittuut'},
                {'Cities': ['Attu', 'Iginniarfik', 'Ikerasaarsuk', 'Kangaatsiaq', 'Niaqornaarsuk'], 'StateName': 'Kangaatsiaq'},
                {'Cities': ['Atammik', 'Kangaamiut', 'Maniitsoq', 'Napasoq'], 'StateName': 'Maniitsoq'},
                {
                ...
                {'Cities': ['Kangerluarsoruseq', 'Kapisillit', 'Neriunaq', 'Nuuk', 'Qeqertarsuatsiaat', 'Qooqqut', 'Qoornoq'], 'StateName': 'Nuuk'},
                {'Cities': ['Arsuk', 'Paamiut'], 'StateName': 'Paamiut'},
                {'Cities': ['Moriusaq', 'Qaanaaq', 'Qeqertarsuaq', 'Qeqertat', 'Savissivik', 'Siorapaluk'], 'StateName': 'Qaanaaq'},
                {
                ...
                {'Cities': ['Itilleq', 'Kangerlussuaq', 'Sarfannguit', 'Sisimiut'], 'StateName': 'Sisimiut'},
                {'Cities': [], 'StateName': 'Udenfor kommunal inddeling'},
                {
                    'Cities': ['Aappilattoq', 'Ikerakuuk', 'Innarsuit', 'Kangersuatsiaq', 'Kullorsuaq', 'Naajaat', 'Nutaarmiut', 'Nuusuaq', 'Tasiusaq', 'Upernavik', 'Upernavik Kujalleq'],
                    'StateName': 'Upernavik'
                },
                {'Cities': ['Ikerasak', 'Illorsuit', 'Niaqornat', 'Nuugaatsiaq', 'Qaarsut', 'Saattut', 'Ukkusissat', 'Uummannaq'], 'StateName': 'Uummannaq'}],
        ...
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Saint John'},
                {'Cities': [], 'StateName': 'Saint Mark'},
                {'Cities': [], 'StateName': 'Saint Patrick'}], 'CountryName': 'Grenada', 'dial_code': '1473', 'code': 'GD'
        },
        {
            'States': [
                {
                ...
                {'Cities': [], 'StateName': 'Saint Martin'}], 'CountryName': 'Guadeloupe', 'dial_code': '590', 'code': 'GP'
        },
        {
            'States': [
                ...
                {'Cities': ['Astumbo', 'Dededo', 'Finegayan Station'], 'StateName': 'Dededo'},
                ...
                {'Cities': ['Yona'], 'StateName': 'Yona'}], 'CountryName': 'Guam', 'dial_code': '1671', 'code': 'GU'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Alta Verapaz'},
                {'Cities': [], 'StateName': 'Baja Verapaz'},
                {'Cities': ['Chimaltenango', 'Comalapa', 'Itzapa', 'Patzun'], 'StateName': 'Chimaltenango'},
                {'Cities': ['Chiquimula', 'Esquipulas'], 'StateName': 'Chiquimula'},
                {'Cities': [], 'StateName': 'El Progreso'},
                {'Cities': ['Cotzumalguapa', 'Escuintla', 'Palin', 'San Jose', 'Tiquisate'], 'StateName': 'Escuintla'},
                {'Cities': ['Amatitlan', 'Chinautla', 'Guatemala', 'Mixco', 'Petapa', 'Villa Nueva'], 'StateName': 'Guatemala'},
                ...
                {'Cities': ['Antigua', 'Ciudad Vieja', 'Jocotenango', 'Santa Maria de Jesus', 'Sumpango'], 'StateName': 'Sacatepequez'},
                ...
                {'Cities': ['Zacapa'], 'StateName': 'Zacapa'}], 'CountryName': 'Guatemala', 'dial_code': '502', 'code': 'GT'
        },
        {
            'States': [
                ...
                {'Cities': ['Vale'], 'StateName': 'Vale'}], 'CountryName': 'Guernsey and Alderney', 'dial_code': '44', 'code': 'GG'
        },
        {
            'States': [
                ...
                {'Cities': ['Yomou'], 'StateName': 'Yomou'}], 'CountryName': 'Guinea', 'dial_code': '224', 'code': 'GN'
        },
        {
            'States': [
                ...
                {'Cities': ['Catio'], 'StateName': 'Tombali'}], 'CountryName': 'Guinea-Bissau', 'dial_code': '245', 'code': 'GW'
        },
        {
            'States': [
                {'Cities': ['Mabaruma', 'Morawhanna'], 'StateName': 'Barima-Waini'},
                {'Cities': ['Bartica', 'Issano', 'Kamarang'], 'StateName': 'Cuyuni-Mazaruni'},
                {'Cities': ['Georgetown', 'Mahaica', 'Paradise', 'Queenstown'], 'StateName': 'Demerara-Mahaica'},
                {'Cities': [], 'StateName': 'East Berbice-Corentyne'},
                {'Cities': [], 'StateName': 'Essequibo Islands-West Demerar'},
                {'Cities': ['Fort Wellington', 'Mahaicony', 'Rosignol'], 'StateName': 'Mahaica-Berbice'},
                {'Cities': ['Anna Regina', 'Charity', 'Suddie'], 'StateName': 'Pomeroon-Supenaam'},
                {'Cities': ['Mahdia', 'Tumatumari'], 'StateName': 'Potaro-Siparuni'},
                {'Cities': [], 'StateName': 'Upper Demerara-Berbice'},
                {'Cities': [], 'StateName': 'Upper Takutu-Upper Essequibo'}], 'CountryName': 'Guyana', 'dial_code': '595', 'code': 'GY'
        },
        {
            'States': [
                {
                ...
                {'Cities': ['Anse-d\'Hainault', 'Dame Marie', 'Jeremie', 'Miragoane'], 'StateName': 'Grand\'Anse'},
                {'Cities': ['Cap-Haitien', 'Croix-des-Bouquets', 'Grande Riviere du Nord', 'Limbe', 'Pignon'], 'StateName': 'Nord'},
                {'Cities': ['Derac', 'Fort-Liberte', 'Ouanaminthe', 'Trou-du-Nord'], 'StateName': 'Nord-Est'},
                {'Cities': ['Port-de-Paix', 'Saint-Louis-du-Nord'], 'StateName': 'Nord-Ouest'},
                {'Cities': ['Anse-a-Galets', 'Carrefour', 'Delmas', 'Kenscoff', 'Lascahobas', 'Leogane', 'Petionville', 'Petit Goave', 'Port-au-Prince'], 'StateName': 'Ouest'},
                {'Cities': ['Aquin', 'Les Cayes'], 'StateName': 'Sud'},
                {'Cities': ['Jacmel'], 'StateName': 'Sud-Est'}], 'CountryName': 'Haiti', 'dial_code': '509', 'code': 'HT'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Heard and McDonald Islands'}], 'CountryName': 'Heard and McDonald Islands'
        },
        {
            'States': [
                {'Cities': ['La Ceiba', 'Olanchito', 'Tela'], 'StateName': 'Atlantida'},
                {'Cities': ['Choluteca', 'El Triunfo', 'Pespire'], 'StateName': 'Choluteca'},
                {'Cities': ['Sonaguera', 'Tocoa', 'Trujillo'], 'StateName': 'Colon'},
                {'Cities': ['Comayagua', 'Siguatepeque'], 'StateName': 'Comayagua'},
                {'Cities': ['Copan', 'Corquin', 'Dulce Nombre', 'El Paraiso', 'San Antonio', 'San Nicolas', 'Santa Rosa de Copan'], 'StateName': 'Copan'},
                {'Cities': ['Choloma', 'La Lima', 'Omoa', 'Puerto Cortes', 'San Pedro Sula'], 'StateName': 'Cortes'},
                ...
                {'Cities': ['Intibuca', 'La Esperanza', 'Utila'], 'StateName': 'Intibuca'},
                {'Cities': [], 'StateName': 'Islas de la Bahia'},
                {'Cities': [], 'StateName': 'La Paz'},
                {'Cities': ['Gracias'], 'StateName': 'Lempira'},
                {'Cities': ['Ocotepeque', 'San Marcos', 'Sinuapa'], 'StateName': 'Ocotepeque'},
                {'Cities': ['Catacamas', 'Juticalpa'], 'StateName': 'Olancho'},
                {'Cities': [], 'StateName': 'Santa Barbara'},
                {'Cities': ['Amapala', 'Langue', 'Nacaome', 'San Lorenzo'], 'StateName': 'Valle'},
                {'Cities': ['El Progreso', 'Morazan', 'Santa Rita', 'Yoro'], 'StateName': 'Yoro'}], 'CountryName': 'Honduras', 'dial_code': '504', 'code': 'HN'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Hong Kong'}], 'CountryName': 'Hong Kong S.A.R.', 'dial_code': '852', 'code': 'HK'
        },
        {
            'States': [
                {
                ...
                },
                {
                    ...
                    'StateName': 'Zala'
                }], 'CountryName': 'Hungary', 'dial_code': '36', 'code': 'HU'
        },
        {
            'States': [
                {
                ...
                {'Cities': ['Akranes', 'Borgarnes', 'Bu ardalur', 'Grundarfjor ur', 'Hellissandur', 'Hvanneyri', 'Olafsvik', 'Rif', 'Stykkisholmur'], 'StateName': 'Vesturland'}],
            'CountryName': 'Iceland',
            'dial_code': '354',
            'code': 'IS'
        },
        {
            'States': [
                {'Cities': ['Bombuflat', 'Garacharma', 'Port Blair', 'Rangat'], 'StateName': 'Andaman and Nicobar Islands'},
                {
                ...
                {'Cities': ['Agethi', 'Amini', 'Androth Island', 'Kavaratti', 'Minicoy'], 'StateName': 'Lakshadweep'},
                {
                ...
                {'Cities': ['Chumukedima', 'Dimapur', 'Kohima', 'Mokokchung', 'Mon', 'Phek', 'Tuensang', 'Wokha', 'Zunheboto'], 'StateName': 'Nagaland'},
                ...
                {'Cities': ['Ariankuppam', 'Karaikal', 'Kurumbapet', 'Mahe', 'Ozhukarai', 'Pondicherry', 'Villianur', 'Yanam'], 'StateName': 'Pondicherry'},
                {
                ...
                {'Cities': ['Gangtok', 'Gezing', 'Jorethang', 'Mangan', 'Namchi', 'Naya Bazar', 'No City', 'Rangpo', 'Sikkim', 'Singtam', 'Upper Tadong'], 'StateName': 'Sikkim'},
                {
                ...
                }], 'CountryName': 'India', 'dial_code': '91', 'code': 'IN'
        },
        {
            'States': [
                {'Cities': ['Banda Aceh', 'Bireun', 'Langsa', 'Lhokseumawe', 'Meulaboh'], 'StateName': 'Aceh'},
                {'Cities': ['Denpasar', 'Karangasem', 'Klungkung', 'Kuta', 'Negara', 'Singaraja', 'Tabanan', 'Ubud'], 'StateName': 'Bali'},
                {'Cities': ['Manggar', 'Mentok', 'Pangkal Pinang', 'Sungai Liat', 'Tanjung Pandan', 'Toboali-Rias'], 'StateName': 'Bangka-Belitung'},
                {
                ...
                {'Cities': ['Jambi', 'Kualatungka', 'Simpang', 'Sungaipenuh'], 'StateName': 'Jambi'},
                ...
                {'Cities': ['Bandar Lampung', 'Kota Bumi', 'Metro', 'Pringsewu', 'Terbanggi Besar'], 'StateName': 'Lampung'},
                ...
                {'Cities': ['Aberpura', 'Biak', 'Jaya Pura', 'Manokwari', 'Merauke', 'Sorong'], 'StateName': 'Papua'},
                {'Cities': ['Balaipungut', 'Bengkalis', 'Dumai', 'Duri', 'Pekan Baru', 'Selatpanjang', 'Tanjung Balai-Meral', 'Tembilahan'], 'StateName': 'Riau'},
                {'Cities': ['Balaipungut', 'Bengkalis', 'Dumai', 'Duri', 'Pekan Baru', 'Selatpanjang', 'Tanjung Balai-Meral', 'Tembilahan'], 'StateName': 'Riau Kepulauan'},
                ...
                }], 'CountryName': 'Indonesia', 'dial_code': '62', 'code': 'ID'
        },
        {
            'States': [
                {'Cities': ['Ardabil', 'Garmi', 'Khalkhal', 'Meshkinshahr', 'Parsabad'], 'StateName': 'Ardabil'},
                {'Cities': [], 'StateName': 'Azarbayjan-e Bakhtari'},
                {'Cities': [], 'StateName': 'Azarbayjan-e Khavari'},
                {'Cities': ['Bandar-e Gonaveh', 'Borazjan', 'Bushehr', 'Dashti', 'Dir', 'Khormuj', 'Kongan', 'Tangestan'], 'StateName': 'Bushehr'},
                ...
                {'Cities': ['Aq Qal\'eh', 'Azad Shahr', 'Bandar-e Torkaman', 'Gonbad-e Qabus', 'Gorgan'], 'StateName': 'Golestan'},
                {'Cities': ['Asadabad', 'Bahar', 'Hamadan', 'Malayer', 'Nahavand', 'Tuysarkan'], 'StateName': 'Hamadan'},
                {'Cities': ['Bandar Abbas', 'Bandar-e \'Abbas', 'Bandar-e Lengeh', 'Gheshm', 'Jask', 'Kish', 'Kish Island', 'Minab'], 'StateName': 'Hormozgan'},
                {'Cities': ['Abdanan', 'Darrehshahr', 'Dehloran', 'Ilam', 'Ivan', 'Mehran'], 'StateName': 'Ilam'},
                {'Cities': ['Baft', 'Bam', 'Bardsir', 'Jiroft', 'Kahnuj', 'Kerman', 'Rafsanjan', 'Ravar', 'Shahr-e Babak', 'Sirjan', 'Zarand'], 'StateName': 'Kerman'},
                {
                ...
                {'Cities': ['Baneh', 'Bijar', 'Kamyaran', 'Marivan', 'Qorveh', 'Sanandaj', 'Saqqez'], 'StateName': 'Kordestan'},
                {'Cities': ['Alashtar', 'Aligudarz', 'Azna', 'Borujerd', 'Do Rud', 'Khorramabad', 'Kuhdasht', 'Nurabad'], 'StateName': 'Lorestan'},
                {'Cities': ['Arak', 'Ashtian', 'Delijan', 'Khomeyn', 'Mahallat', 'Sarband', 'Saveh', 'Tafresh'], 'StateName': 'Markazi'},
                {
                ...
                {'Cities': ['Abhar', 'Abyek', 'Qazvin', 'Takestan'], 'StateName': 'Qazvin'},
                {'Cities': ['Qom'], 'StateName': 'Qom'},
                {'Cities': ['Damghan', 'Garmsar', 'Semnan', 'Shahrud'], 'StateName': 'Semnan'},
                ...
                {'Cities': ['Ardakan', 'Bafq', 'Mehriz', 'Meybod', 'Taft', 'Yazd'], 'StateName': 'Yazd'},
                {'Cities': ['Alvand', 'Khorramdarreh', 'Zanjan'], 'StateName': 'Zanjan'}], 'CountryName': 'Iran', 'dial_code': '98', 'code': 'IR'
        },
        {
            'States': [
                {'Cities': ['Jurf-as-Sakhr', 'Saddat-al-Hindiyah', 'al-Hillah', 'al-Madhatiyah', 'al-Musayyib', 'al-Qasim'], 'StateName': 'Babil'},
                {'Cities': ['Baghdad'], 'StateName': 'Baghdad'},
                {'Cities': ['Dahuk', 'Zakhu'], 'StateName': 'Dahuk'},
                {'Cities': [], 'StateName': 'Dhi Qar'},
                {'Cities': ['Ba\'qubah', 'Hanaqin', 'Jalula\'\'', 'Kifri', 'Mandali', 'al-Fuhud', 'al-Khalis', 'al-Miqdadiyah', 'ash-Shatrah'], 'StateName': 'Diyala'},
                ...
                {'Cities': ['\'Ali al Gharbi', 'al-\'Amarah', 'al-Majarr-al-Kabir'], 'StateName': 'Maysan'},
                {'Cities': ['Qarah Qush', 'Sinjar', 'Tall \'Afar', 'Tall Kayf', 'al-Mawsil', 'ash-Shaykhan'], 'StateName': 'Ninawa'},
                {'Cities': ['Balad', 'Bayji', 'Dhalu\'iyah', 'Samarra', 'Tikrit', 'Tuz', 'ad-Dujayl'], 'StateName': 'Salah-ad-Din'},
                {'Cities': ['al-\'Aziziyah', 'al-Hayy', 'al-Kut', 'an-Nu\'maniyah', 'as-Suwayrah'], 'StateName': 'Wasit'},
                {'Cities': ['\'Anah', 'Hit', 'Rawah', 'al-Fallujah', 'al-Habbaniyah', 'al-Hadithah', 'ar-Ramadi', 'ar-Rutbah'], 'StateName': 'al-Anbar'},
                {'Cities': ['Abu al-Khasib', 'Harithah', 'Shatt-al-\'Arab', 'al-Basrah', 'al-Faw', 'al-Qurnah', 'az-Zubayr'], 'StateName': 'al-Basrah'},
                {'Cities': ['ar-Rumaythah', 'as-Samawah'], 'StateName': 'al-Muthanna'},
                {'Cities': ['\'Afak', 'ad-Diwaniyah', 'al-Ghammas', 'al-Hamzah', 'ash-Shamiyah', 'ash-Shinafiyah'], 'StateName': 'al-Qadisiyah'},
                {'Cities': ['al-Kufah', 'al-Mishkhab', 'an-Najaf'], 'StateName': 'an-Najaf'},
                {'Cities': ['Chamchamal', 'Halabjah', 'Kusanjaq', 'Panjwin', 'Qal\'at Dizeh', 'as-Sulaymaniyah'], 'StateName': 'as-Sulaymaniyah'},
                {'Cities': ['\'Aqrah', 'Kirkuk'], 'StateName': 'at-Ta\'mim'}], 'CountryName': 'Iraq', 'dial_code': '964', 'code': 'IQ'
        },
        {
            'States': [
                {'Cities': ['Moira'], 'StateName': 'Armagh'},
                {'Cities': ['Bagenalstown', 'Carlow', 'Tullow'], 'StateName': 'Carlow'},
                {'Cities': ['Bailieborough', 'Belturbet', 'Cavan', 'Coothill'], 'StateName': 'Cavan'},
                {'Cities': ['Ennis', 'Kilkee', 'Kilrush', 'Newmarket-on-Fergus', 'Shannon'], 'StateName': 'Clare'},
                {
                ...
                {'Cities': ['Balbriggan', 'Ballsbridge', 'Dublin', 'Leixlip', 'Lucan', 'Malahide', 'Portrane', 'Rathcoole', 'Rush', 'Skerries', 'Swords'], 'StateName': 'Dublin'},
                {'Cities': ['Athenry', 'Ballinasloe', 'Clifden', 'Galway', 'Gort', 'Loughrea', 'Tuam'], 'StateName': 'Galway'},
                {'Cities': ['Ballybunion', 'Cahirciveen', 'Castleisland', 'Dingle', 'Kenmare', 'Killarney', 'Killorglin', 'Listowel', 'Tralee'], 'StateName': 'Kerry'},
                {'Cities': ['Athy', 'Celbridge', 'Clane', 'Kilcock', 'Kilcullen', 'Kildare', 'Maynooth', 'Monasterevan', 'Naas', 'Newbridge'], 'StateName': 'Kildare'},
                {'Cities': ['Callan', 'Castlecomer', 'Kilkenny', 'Thomastown'], 'StateName': 'Kilkenny'},
                {'Cities': ['Abbeyleix', 'Mountmellick', 'Mountrath', 'Port Laoise', 'Portarlington'], 'StateName': 'Laois'},
                {'Cities': ['Meath'], 'StateName': 'Leinster'},
                {'Cities': ['Carrick-on-Shannon'], 'StateName': 'Leitrim'},
                {'Cities': ['Abbeyfeale', 'Kilmallock', 'Limerick', 'Newcastle', 'Rathkeale'], 'StateName': 'Limerick'},
                {'Cities': [], 'StateName': 'Loch Garman'},
                {'Cities': ['Granard', 'Longford', 'Moate'], 'StateName': 'Longford'},
                {'Cities': ['Ardee', 'Drogheda', 'Drumcar', 'Dundalk'], 'StateName': 'Louth'},
                {'Cities': ['Ballina', 'Ballinrobe', 'Ballyhaunis', 'Castlebar', 'Claremorris', 'Swinford', 'Westport'], 'StateName': 'Mayo'},
                {'Cities': ['Ashbourne', 'Duleek', 'Dunboyne', 'Dunshaughlin', 'Kells', 'Laytown', 'Navan', 'Trim'], 'StateName': 'Meath'},
                {'Cities': ['Carrickmacross', 'Castleblayney', 'Clones', 'Monaghan'], 'StateName': 'Monaghan'},
                {'Cities': ['Banagher', 'Birr', 'Clara', 'Edenderry', 'Kilcormac', 'Tullamore'], 'StateName': 'Offaly'},
                {'Cities': ['Ballaghaderreen', 'Boyle', 'Castlerea', 'Roscommon'], 'StateName': 'Roscommon'},
                ...
                {'Cities': ['Dungarvan', 'Tramore', 'Waterford'], 'StateName': 'Waterford'},
                {'Cities': ['Athlone', 'Mullingar'], 'StateName': 'Westmeath'},
                {'Cities': ['Enniscorthy', 'Gorey', 'New Ross', 'Wexford'], 'StateName': 'Wexford'},
                {'Cities': ['Arklow', 'Baltinglass', 'Blessington', 'Bray', 'Greystones', 'Kilcoole', 'Newtownmountkennedy', 'Rathdrum', 'Wicklow'], 'StateName': 'Wicklow'}],
            'CountryName': 'Ireland',
            'dial_code': '353',
            'code': 'IE'
        },
        {
            'States': [
                ...
                {'Cities': ['Bet Shemesh', 'Mevasserat Ziyyon', 'Yerushalayim'], 'StateName': 'Yerushalayim'}], 'CountryName': 'Israel', 'dial_code': '972', 'code': 'IL'
        },
        {
            'States': [
                ...
                {
                    'Cities': ['Agrigento', 'Alessandria della Rocca', 'Aragona', 'Bivona', 'Burgio', 'Calamonaci', 'Caltabellotta', 'Camastra', 'Cammarata', 'Campobello di Licata', 'Canicatt\u00c3\u0083\u00c6\u0092\u00c3\u0082\u00c2\u00ac', 'Casteltermini', 'Castrofilippo', 'Cattolica Eraclea', 'Cianciana', 'Comitini', 'Favara', 'Grotte', 'Joppolo Giancaxio', 'Lampedusa e Linosa', 'Licata', 'Lucca Sicula', 'Menfi', 'Montallegro', 'Montevago', 'Naro', 'Palma di Montechiaro', 'Porto Empedocle', 'Racalmuto', 'Raffadali', 'Ravanusa', 'Realmonte', 'Ribera', 'Sambuca di Sicilia', 'San Biagio Platani', 'San Giovanni Gemini', 'Sant Angelo Muxaro', 'Santa Elisabetta', 'Santa Margherita di Belice', 'Santo Stefano Quisquina', 'Sciacca', 'Siculiana', 'Villafranca Sicula'],
                    'StateName': 'Agrigento'
                },
                {'Cities': ['Castellazzo Bormida', 'Gavi', 'Villanova Monferrato'], 'StateName': 'Alessandria'},
                {'Cities': ['Camerano', 'Castelplanio'], 'StateName': 'Ancona'},
                {'Cities': ['Capolona', 'Montevarchi', 'Subbiano'], 'StateName': 'Arezzo'},
                {'Cities': [], 'StateName': 'Ascoli Piceno'},
                {'Cities': ['Buttigliera d\'Asti'], 'StateName': 'Asti'},
                {'Cities': ['Flumeri', 'Nusco', 'Prata di Principato Ultra', 'Villanova del Battista'], 'StateName': 'Avellino'},
                ...
                {'Cities': ['Belluno', 'D\'alpago', 'Longarone', 'Pedavena'], 'StateName': 'Belluno'},
                ...
                {'Cities': ['Camburzano', 'Crevacuore', 'Gaglianico', 'Sandigliano', 'Vigliano Biellese'], 'StateName': 'Biella'},
                {
                ...
                {'Cities': ['Casalbuttano', 'Casalmaggiore', 'Castelverde', 'Madignano', 'Pieve San Giacomo'], 'StateName': 'Cremona'},
                {'Cities': ['Bandito', 'Bra', 'Casalgrasso', 'Cossano Belbo', 'Magliano Alpi', 'Mondovi', 'Roddi', 'Santa Vittoria d\'Alba', 'Verduno'], 'StateName': 'Cuneo'},
                {
                ...
                {'Cities': ['Capalle', 'Firenze', 'Pelago', 'San Donnino', 'Scarperia'], 'StateName': 'Firenze'},
                {'Cities': ['Scandicci', 'Sesto Fiorentino'], 'StateName': 'Florence'},
                {'Cities': [], 'StateName': 'Forli-Cesena '},
                {'Cities': [], 'StateName': 'Friuli-Venezia Giulia'},
                {'Cities': ['Casalvieri', 'Frosinone', 'Sgurgola'], 'StateName': 'Frosinone'},
                {'Cities': ['Genoa', 'Moneglia'], 'StateName': 'Genoa'},
                {'Cities': ['Romans d\'Isonzo', 'Savogna d\'Isonzo'], 'StateName': 'Gorizia'},
                ...
                {'Cities': ['Airuno', 'Bosisio Parini', 'Lecco', 'Margno', 'Osnago', 'Sirone'], 'StateName': 'Lecco'},
                {'Cities': ['Airuno', 'Bosisio Parini', 'Lecco', 'Margno', 'Osnago', 'Sirone'], 'StateName': 'Lecco Province'},
                {
                ...
                {'Cities': ['Castel', 'Gazoldo', 'Marmirolo', 'Monzambano', 'Ostiglia', 'Pegognaga', 'Poggio Rusco', 'Quistello', 'Roverbella', 'Suzzara'], 'StateName': 'Mantova'},
                {
                ...
                {'Cities': ['Bomporto', 'Campogalliano', 'Cavezzo', 'Medolla', 'Nonantola', 'San Possidonio', 'Sassuolo', 'Spilamberto'], 'StateName': 'Modena'},
                {'Cities': ['Bojano', 'Campobasso', 'Cantalupo', 'Isernia', 'Termoli', 'Venafro'], 'StateName': 'Molise'},
                ...
                {'Cities': [], 'StateName': 'Viterbo'}], 'CountryName': 'Italy', 'dial_code': '39', 'code': 'IT'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Westmoreland'}], 'CountryName': 'Jamaica', 'dial_code': '1876', 'code': 'JM'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Yamanashi'}], 'CountryName': 'Japan', 'dial_code': '81', 'code': 'JP'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Saint Peter'},
                {'Cities': [], 'StateName': 'Saint Saviour'},
                {'Cities': [], 'StateName': 'Trinity'}], 'CountryName': 'Jersey', 'dial_code': '44', 'code': 'JE'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'az-Zarqa\''}], 'CountryName': 'Jordan', 'dial_code': '962', 'code': 'JO'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Taraz'}], 'CountryName': 'Kazakhstan', 'dial_code': '77', 'code': 'KZ'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Western'}], 'CountryName': 'Kenya', 'dial_code': '254', 'code': 'KE'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Teraina'}], 'CountryName': 'Kiribati', 'dial_code': '686', 'code': 'KI'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Yanggang'}], 'CountryName': 'Korea North', 'dial_code': '850', 'code': 'KP'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'gwangyoksi'}], 'CountryName': 'Korea South', 'dial_code': '82', 'code': 'KR'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'al-Kuwayt'}], 'CountryName': 'Kuwait', 'dial_code': '965', 'code': 'KW'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Talas'}], 'CountryName': 'Kyrgyzstan', 'dial_code': '996', 'code': 'KG'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Xiang Khuang'}], 'CountryName': 'Laos', 'dial_code': '856', 'code': 'LA'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Ventspils City'}], 'CountryName': 'Latvia', 'dial_code': '371', 'code': 'LV'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'ash-Shamal'}], 'CountryName': 'Lebanon', 'dial_code': '961', 'code': 'LB'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Thaba-Tseka'}], 'CountryName': 'Lesotho', 'dial_code': '266', 'code': 'LS'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Sinoe'}], 'CountryName': 'Liberia', 'dial_code': '231', 'code': 'LR'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'az-Zawiyah'}], 'CountryName': 'Libya', 'dial_code': '218', 'code': 'LY'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Vaduz'}], 'CountryName': 'Liechtenstein', 'dial_code': '423', 'code': 'LI'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Vilniaus'}], 'CountryName': 'Lithuania', 'dial_code': '370', 'code': 'LT'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Wiltz'}], 'CountryName': 'Luxembourg', 'dial_code': '352', 'code': 'LU'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Macau'}], 'CountryName': 'Macau S.A.R.'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Vinica'}], 'CountryName': 'Macedonia', 'dial_code': '389', 'code': 'MK'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Toliary'}], 'CountryName': 'Madagascar', 'dial_code': '261', 'code': 'MG'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Zomba Municipality'}], 'CountryName': 'Malawi', 'dial_code': '265', 'code': 'MW'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Terengganu'}], 'CountryName': 'Malaysia', 'dial_code': '60', 'code': 'MY'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Vaav'}], 'CountryName': 'Maldives', 'dial_code': '960', 'code': 'MV'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Tombouctou'}], 'CountryName': 'Mali', 'dial_code': '223', 'code': 'ML'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Western'}], 'CountryName': 'Malta', 'dial_code': '356', 'code': 'MT'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Ramsey'}], 'CountryName': 'Man (Isle of)', 'dial_code': '44', 'code': 'IM'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Wotje'}], 'CountryName': 'Marshall Islands', 'dial_code': '692', 'code': 'MH'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Saint-Pierre'}], 'CountryName': 'Martinique', 'dial_code': '596', 'code': 'MQ'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Trarza'}], 'CountryName': 'Mauritania', 'dial_code': '222', 'code': 'MR'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Savanne'}], 'CountryName': 'Mauritius', 'dial_code': '230', 'code': 'MU'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Mayotte'},
                {'Cities': [], 'StateName': 'Pamanzi'}], 'CountryName': 'Mayotte', 'dial_code': '262', 'code': 'YT'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Zacatecas'}], 'CountryName': 'Mexico', 'dial_code': '52', 'code': 'MX'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Yap'}], 'CountryName': 'Micronesia', 'dial_code': '691', 'code': 'FM'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Ungheni'}], 'CountryName': 'Moldova', 'dial_code': '373', 'code': 'MD'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Monte Carlo'}], 'CountryName': 'Monaco', 'dial_code': '377', 'code': 'MC'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Zavhan'}], 'CountryName': 'Mongolia', 'dial_code': '976', 'code': 'MN'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Montserrat'}], 'CountryName': 'Montserrat', 'dial_code': '1664', 'code': 'MS'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Wilaya de Rabat-Sale'}], 'CountryName': 'Morocco', 'dial_code': '212', 'code': 'MA'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Zambezia'}], 'CountryName': 'Mozambique', 'dial_code': '258', 'code': 'MZ'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Yangon'}], 'CountryName': 'Myanmar', 'dial_code': '95', 'code': 'MM'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Otjozondjupa'}], 'CountryName': 'Namibia', 'dial_code': '264', 'code': 'NA'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Yaren'}], 'CountryName': 'Nauru', 'dial_code': '674', 'code': 'NR'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Seti'}], 'CountryName': 'Nepal', 'dial_code': '977', 'code': 'NP'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Sint Maarten'}], 'CountryName': 'Netherlands Antilles', 'dial_code': '599', 'code': 'AN'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Zuid-Holland'}], 'CountryName': 'Netherlands The', 'dial_code': '31', 'code': 'NL'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Iles'},
                {'Cities': [], 'StateName': 'Nord'},
                {'Cities': [], 'StateName': 'Sud'}], 'CountryName': 'New Caledonia', 'dial_code': '687', 'code': 'NC'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'West Coast'}], 'CountryName': 'New Zealand', 'dial_code': '64', 'code': 'NZ'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Rivas'}], 'CountryName': 'Nicaragua', 'dial_code': '505', 'code': 'NI'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Zinder'}], 'CountryName': 'Niger', 'dial_code': '227', 'code': 'NE'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Zamfara'}], 'CountryName': 'Nigeria', 'dial_code': '234', 'code': 'NG'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Niue'}], 'CountryName': 'Niue', 'dial_code': '683', 'code': 'NU'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Norfolk Island'}], 'CountryName': 'Norfolk Island', 'dial_code': '672', 'code': 'NF'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Tinian'}], 'CountryName': 'Northern Mariana Islands', 'dial_code': '1670', 'code': 'MP'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': '\u00c3\u0083\u00c6\u0092\u00c3\u0082\u00cb\u009cstfold'}], 'CountryName': 'Norway', 'dial_code': '47', 'code': 'NO'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'ash-Sharqiyah'}], 'CountryName': 'Oman', 'dial_code': '968', 'code': 'OM'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Sind'}], 'CountryName': 'Pakistan', 'dial_code': '92', 'code': 'PK'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Sonsorol'}], 'CountryName': 'Palau', 'dial_code': '680', 'code': 'PW'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'al-Quds'}], 'CountryName': 'Palestinian Territory Occupied', 'dial_code': '970', 'code': 'PS'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Veraguas'}], 'CountryName': 'Panama', 'dial_code': '507', 'code': 'PA'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Western Highlands'}], 'CountryName': 'Papua new Guinea'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'San Pedro'}], 'CountryName': 'Paraguay', 'dial_code': '595', 'code': 'PY'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Ucayali'}], 'CountryName': 'Peru', 'dial_code': '51', 'code': 'PE'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Western Visayas'}], 'CountryName': 'Philippines', 'dial_code': '63', 'code': 'PH'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Pitcairn Island'}], 'CountryName': 'Pitcairn Island'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Zukowo'}], 'CountryName': 'Poland', 'dial_code': '48', 'code': 'PL'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Paivas'}], 'CountryName': 'Portugal', 'dial_code': '351', 'code': 'PT'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'San Juan'}], 'CountryName': 'Puerto Rico', 'dial_code': '1939', 'code': 'PR'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'ash-Shamal'}], 'CountryName': 'Qatar', 'dial_code': '974', 'code': 'QA'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Saint-Paul'},
                {'Cities': [], 'StateName': 'Saint-Pierre'}], 'CountryName': 'Reunion'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Vrancea'}], 'CountryName': 'Romania', 'dial_code': '40', 'code': 'RO'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Voronezh'}], 'CountryName': 'Russia', 'dial_code': '7', 'code': 'RU'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Ruhengeri'}], 'CountryName': 'Rwanda', 'dial_code': '250', 'code': 'RW'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Tristan da Cunha'}], 'CountryName': 'Saint Helena', 'dial_code': '290', 'code': 'SH'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Trinity Palmetto Point'}], 'CountryName': 'Saint Kitts And Nevis'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Vieux Fort'}], 'CountryName': 'Saint Lucia', 'dial_code': '1758', 'code': 'LC'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Miquelon-Langlade'},
                {'Cities': [], 'StateName': 'Saint-Pierre'}], 'CountryName': 'Saint Pierre and Miquelon', 'dial_code': '508', 'code': 'PM'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Saint David'},
                {'Cities': [], 'StateName': 'Saint George'},
                {'Cities': [], 'StateName': 'Saint Patrick'}], 'CountryName': 'Saint Vincent And The Grenadines'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Vaisigano'}], 'CountryName': 'Samoa', 'dial_code': '685', 'code': 'WS'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Serravalle'}], 'CountryName': 'San Marino', 'dial_code': '378', 'code': 'SM'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Pague'}], 'CountryName': 'Sao Tome and Principe', 'dial_code': '239', 'code': 'ST'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'ar-Riyad'}], 'CountryName': 'Saudi Arabia', 'dial_code': '966', 'code': 'SA'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Ziguinchor'}], 'CountryName': 'Senegal', 'dial_code': '221', 'code': 'SN'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Central Serbia'},
                {'Cities': [], 'StateName': 'Kosovo and Metohija'},
                {'Cities': [], 'StateName': 'Vojvodina'}], 'CountryName': 'Serbia', 'dial_code': '381', 'code': 'RS'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Victoria'}], 'CountryName': 'Seychelles', 'dial_code': '248', 'code': 'SC'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Eastern'},
                ...
                {'Cities': [], 'StateName': 'Western'}], 'CountryName': 'Sierra Leone', 'dial_code': '232', 'code': 'SL'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Singapore'}], 'CountryName': 'Singapore', 'dial_code': '65', 'code': 'SG'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Zilinsky'}], 'CountryName': 'Slovakia', 'dial_code': '421', 'code': 'SK'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Zasavska'}], 'CountryName': 'Slovenia', 'dial_code': '386', 'code': 'SI'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Pitcairn'}], 'CountryName': 'Smaller Territories of the UK'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Central'},
                ...
                {'Cities': [], 'StateName': 'Western'}], 'CountryName': 'Solomon Islands', 'dial_code': '677', 'code': 'SB'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Woqoyi Galbed'}], 'CountryName': 'Somalia', 'dial_code': '252', 'code': 'SO'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Western Cape'}], 'CountryName': 'South Africa', 'dial_code': '27', 'code': 'ZA'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'South Georgia'}], 'CountryName': 'South Georgia', 'dial_code': '500', 'code': 'GS'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Central Equatoria'}], 'CountryName': 'South Sudan', 'dial_code': '211', 'code': 'SS'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Zaragoza'}], 'CountryName': 'Spain', 'dial_code': '34', 'code': 'ES'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'kadawatha'}], 'CountryName': 'Sri Lanka', 'dial_code': '94', 'code': 'LK'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'ash-Shamaliyah'}], 'CountryName': 'Sudan', 'dial_code': '249', 'code': 'SD'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Wanica'}], 'CountryName': 'Suriname', 'dial_code': '597', 'code': 'SR'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Svalbard'}], 'CountryName': 'Svalbard And Jan Mayen Islands', 'dial_code': '47', 'code': 'SJ'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Shiselweni'}], 'CountryName': 'Swaziland', 'dial_code': '268', 'code': 'SZ'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Vastra Gotaland'}], 'CountryName': 'Sweden', 'dial_code': '46', 'code': 'SE'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Zurich'}], 'CountryName': 'Switzerland', 'dial_code': '41', 'code': 'CH'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'as-Suwayda'}], 'CountryName': 'Syria', 'dial_code': '963', 'code': 'SY'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Yunlin'}], 'CountryName': 'Taiwan', 'dial_code': '886', 'code': 'TW'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Sughd'}], 'CountryName': 'Tajikistan', 'dial_code': '992', 'code': 'TJ'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Zanzibar and Pemba'}], 'CountryName': 'Tanzania', 'dial_code': '255', 'code': 'TZ'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Yasothon'}], 'CountryName': 'Thailand', 'dial_code': '66', 'code': 'TH'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Savanes'}], 'CountryName': 'Togo', 'dial_code': '228', 'code': 'TG'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Atafu'},
                {'Cities': [], 'StateName': 'Fakaofo'},
                {'Cities': [], 'StateName': 'Nukunonu'}], 'CountryName': 'Tokelau', 'dial_code': '690', 'code': 'TK'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Vava\'u'}], 'CountryName': 'Tonga', 'dial_code': '676', 'code': 'TO'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Tobago'}], 'CountryName': 'Trinidad And Tobago'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'al-Qayrawan'}], 'CountryName': 'Tunisia', 'dial_code': '216', 'code': 'TN'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Zonguldak'}], 'CountryName': 'Turkey', 'dial_code': '90', 'code': 'TR'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Mari'}], 'CountryName': 'Turkmenistan', 'dial_code': '993', 'code': 'TM'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Grand Turk'},
                {'Cities': [], 'StateName': 'South Caicos and East Caicos'}], 'CountryName': 'Turks And Caicos Islands'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Vaitupu'}], 'CountryName': 'Tuvalu', 'dial_code': '688', 'code': 'TV'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Central'},
                {'Cities': [], 'StateName': 'Eastern'},
                {'Cities': [], 'StateName': 'Northern'},
                {'Cities': [], 'StateName': 'Western'}], 'CountryName': 'Uganda', 'dial_code': '256', 'code': 'UG'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Zhytomyrs\'ka'}], 'CountryName': 'Ukraine', 'dial_code': '380', 'code': 'UA'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'ash-Shariqah'}], 'CountryName': 'United Arab Emirates', 'dial_code': '971', 'code': 'AE'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Yorkshire'}], 'CountryName': 'United Kingdom', 'dial_code': '44', 'code': 'GB'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Wyoming'}], 'CountryName': 'United States', 'dial_code': '1', 'code': 'US'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'United States Minor Outlying I'}], 'CountryName': 'United States Minor Outlying Islands'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Treinta y Tres'}], 'CountryName': 'Uruguay', 'dial_code': '598', 'code': 'UY'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Toskent'}], 'CountryName': 'Uzbekistan', 'dial_code': '998', 'code': 'UZ'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Torba'}], 'CountryName': 'Vanuatu', 'dial_code': '678', 'code': 'VU'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Vatican City State (Holy See)'}], 'CountryName': 'Vatican City State (Holy See)', 'dial_code': '379', 'code': 'VA'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Amazonas'},
                ...
                {'Cities': [], 'StateName': 'Zulia'}], 'CountryName': 'Venezuela', 'dial_code': '58', 'code': 'VE'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Tinh Gia Lai'}], 'CountryName': 'Vietnam', 'dial_code': '84', 'code': 'VN'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Anegada'},
                {'Cities': [], 'StateName': 'Jost van Dyke'},
                {'Cities': [], 'StateName': 'Tortola'}], 'CountryName': 'Virgin Islands (British)', 'dial_code': '1284', 'code': 'VG'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Saint Croix'},
                {'Cities': [], 'StateName': 'Saint John'},
                {'Cities': [], 'StateName': 'Saint Thomas'}], 'CountryName': 'Virgin Islands (US)'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Alo'},
                {'Cities': [], 'StateName': 'Singave'},
                {'Cities': [], 'StateName': 'Wallis'}], 'CountryName': 'Wallis And Futuna Islands', 'dial_code': '681', 'code': 'WF'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'as-Samarah'}], 'CountryName': 'Western Sahara'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'al-Mahwit'}], 'CountryName': 'Yemen', 'dial_code': '967', 'code': 'YE'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Central Serbia'},
                ...
                {'Cities': [], 'StateName': 'Vojvodina'}], 'CountryName': 'Yugoslavia'
        },
        {
            'States': [
                {'Cities': [], 'StateName': 'Central'},
                ...
                {'Cities': [], 'StateName': 'Northern'},
                {'Cities': [], 'StateName': 'Southern'},
                {'Cities': [], 'StateName': 'Western'}], 'CountryName': 'Zambia', 'dial_code': '260', 'code': 'ZM'
        },
        {
            'States': [
                ...
                {'Cities': [], 'StateName': 'Midlands'}], 'CountryName': 'Zimbabwe', 'dial_code': '263', 'code': 'ZW'
        }
